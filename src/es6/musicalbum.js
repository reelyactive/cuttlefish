    ...
    render() {
                ...
                producer = (
                   <div className='producer-container'>
                       ...
                       {this.props.producer.map((item, index) => {
                           return (<div className='producer' data-advice='Put your HTML here. producer is a Person or Organization.'><div className="MusicAlbum-producer">producer: {this.props.producer}</div></div>);
                       })};
                       <div className='producer-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                producer = (<div className='producer' data-advice='Put your HTML here. producer is a Person or Organization.'><div className="MusicAlbum-producer">producer: {this.props.producer}</div></div>);
            }
        }
                ...
                creator = (
                   <div className='creator-container'>
                       ...
                       {this.props.creator.map((item, index) => {
                           return (<div className='creator' data-advice='Put your HTML here. creator is a Person or Organization.'><div className="MusicAlbum-creator">creator: {this.props.creator}</div></div>);
                       })};
                       <div className='creator-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                creator = (<div className='creator' data-advice='Put your HTML here. creator is a Person or Organization.'><div className="MusicAlbum-creator">creator: {this.props.creator}</div></div>);
            }
        }
                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a URL or ImageObject.'><img className="MusicAlbum-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a URL or ImageObject.'><img className="MusicAlbum-image" src={this.props.image} /></div>);
            }
        }
        ...
        if (this.props.albumProductionType) {
            if (this.props.albumProductionType instanceof Array) {
                albumProductionType = (
                   <div className='albumProductionType-container'>
                       <div className='albumProductionType-header' data-advice='HTML for the *head* of the section'>albumProductionTypes</div>
                       {this.props.albumProductionType.map((item, index) => {
                           return (<MusicAlbumProductionType key={index} {...this.props.albumProductionType} />);
                       })};
                       <div className='albumProductionType-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
        ...
        if (this.props.albumRelease) {
            if (this.props.albumRelease instanceof Array) {
                albumRelease = (
                   <div className='albumRelease-container'>
                       <div className='albumRelease-header' data-advice='HTML for the *head* of the section'>albumReleases</div>
                       {this.props.albumRelease.map((item, index) => {
                           return (<MusicRelease key={index} {...this.props.albumRelease} />);
                       })};
                       <div className='albumRelease-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                ...
                contributor = (
                   <div className='contributor-container'>
                       ...
                       {this.props.contributor.map((item, index) => {
                           return (<div className='contributor' data-advice='Put your HTML here. contributor is a Person or Organization.'><div className="MusicAlbum-contributor">contributor: {this.props.contributor}</div></div>);
                       })};
                       <div className='contributor-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                contributor = (<div className='contributor' data-advice='Put your HTML here. contributor is a Person or Organization.'><div className="MusicAlbum-contributor">contributor: {this.props.contributor}</div></div>);
            }
        }
        ...
        if (this.props.albumReleaseType) {
            if (this.props.albumReleaseType instanceof Array) {
                albumReleaseType = (
                   <div className='albumReleaseType-container'>
                       <div className='albumReleaseType-header' data-advice='HTML for the *head* of the section'>albumReleaseTypes</div>
                       {this.props.albumReleaseType.map((item, index) => {
                           return (<MusicAlbumReleaseType key={index} {...this.props.albumReleaseType} />);
                       })};
                       <div className='albumReleaseType-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                ...
                author = (
                   <div className='author-container'>
                       ...
                       {this.props.author.map((item, index) => {
                           return (<div className='author' data-advice='Put your HTML here. author is a Person or Organization.'><div className="MusicAlbum-author">author: {this.props.author}</div></div>);
                       })};
                       <div className='author-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                author = (<div className='author' data-advice='Put your HTML here. author is a Person or Organization.'><div className="MusicAlbum-author">author: {this.props.author}</div></div>);
            }
        }
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="MusicAlbum-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="MusicAlbum-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
                ...
                provider = (
                   <div className='provider-container'>
                       ...
                       {this.props.provider.map((item, index) => {
                           return (<div className='provider' data-advice='Put your HTML here. provider is a Person or Organization.'><div className="MusicAlbum-provider">provider: {this.props.provider}</div></div>);
                       })};
                       <div className='provider-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                provider = (<div className='provider' data-advice='Put your HTML here. provider is a Person or Organization.'><div className="MusicAlbum-provider">provider: {this.props.provider}</div></div>);
            }
        }
                ...
                dateModified = (
                   <div className='dateModified-container'>
                       ...
                       {this.props.dateModified.map((item, index) => {
                           return (<div className='dateModified' data-advice='Put your HTML here. dateModified is a Date or DateTime.'><div className="MusicAlbum-dateModified">dateModified: {this.props.dateModified}</div></div>);
                       })};
                       <div className='dateModified-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                dateModified = (<div className='dateModified' data-advice='Put your HTML here. dateModified is a Date or DateTime.'><div className="MusicAlbum-dateModified">dateModified: {this.props.dateModified}</div></div>);
            }
        }
                ...
                citation = (
                   <div className='citation-container'>
                       ...
                       {this.props.citation.map((item, index) => {
                           return (<div className='citation' data-advice='Put your HTML here. citation is a Text or CreativeWork.'><div className="MusicAlbum-citation">citation: {this.props.citation}</div></div>);
                       })};
                       <div className='citation-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                citation = (<div className='citation' data-advice='Put your HTML here. citation is a Text or CreativeWork.'><div className="MusicAlbum-citation">citation: {this.props.citation}</div></div>);
            }
        }
                ...
                publisher = (
                   <div className='publisher-container'>
                       ...
                       {this.props.publisher.map((item, index) => {
                           return (<div className='publisher' data-advice='Put your HTML here. publisher is a Person or Organization.'><div className="MusicAlbum-publisher">publisher: {this.props.publisher}</div></div>);
                       })};
                       <div className='publisher-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                publisher = (<div className='publisher' data-advice='Put your HTML here. publisher is a Person or Organization.'><div className="MusicAlbum-publisher">publisher: {this.props.publisher}</div></div>);
            }
        }
                ...
                track = (
                   <div className='track-container'>
                       ...
                       {this.props.track.map((item, index) => {
                           return (<div className='track' data-advice='Put your HTML here. track is a ItemList or MusicRecording.'><div className="MusicAlbum-track">track: {this.props.track}</div></div>);
                       })};
                       <div className='track-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                track = (<div className='track' data-advice='Put your HTML here. track is a ItemList or MusicRecording.'><div className="MusicAlbum-track">track: {this.props.track}</div></div>);
            }
        }
                ...
                dateCreated = (
                   <div className='dateCreated-container'>
                       ...
                       {this.props.dateCreated.map((item, index) => {
                           return (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a Date or DateTime.'><div className="MusicAlbum-dateCreated">dateCreated: {this.props.dateCreated}</div></div>);
                       })};
                       <div className='dateCreated-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                dateCreated = (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a Date or DateTime.'><div className="MusicAlbum-dateCreated">dateCreated: {this.props.dateCreated}</div></div>);
            }
        }
                ...
                translator = (
                   <div className='translator-container'>
                       ...
                       {this.props.translator.map((item, index) => {
                           return (<div className='translator' data-advice='Put your HTML here. translator is a Person or Organization.'><div className="MusicAlbum-translator">translator: {this.props.translator}</div></div>);
                       })};
                       <div className='translator-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                translator = (<div className='translator' data-advice='Put your HTML here. translator is a Person or Organization.'><div className="MusicAlbum-translator">translator: {this.props.translator}</div></div>);
            }
        }
                ...
                copyrightHolder = (
                   <div className='copyrightHolder-container'>
                       ...
                       {this.props.copyrightHolder.map((item, index) => {
                           return (<div className='copyrightHolder' data-advice='Put your HTML here. copyrightHolder is a Person or Organization.'><div className="MusicAlbum-copyrightHolder">copyrightHolder: {this.props.copyrightHolder}</div></div>);
                       })};
                       <div className='copyrightHolder-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                copyrightHolder = (<div className='copyrightHolder' data-advice='Put your HTML here. copyrightHolder is a Person or Organization.'><div className="MusicAlbum-copyrightHolder">copyrightHolder: {this.props.copyrightHolder}</div></div>);
            }
        }
                ...
                position = (
                   <div className='position-container'>
                       ...
                       {this.props.position.map((item, index) => {
                           return (<div className='position' data-advice='Put your HTML here. position is a Text or Integer.'><div className="MusicAlbum-position">position: {this.props.position}</div></div>);
                       })};
                       <div className='position-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                position = (<div className='position' data-advice='Put your HTML here. position is a Text or Integer.'><div className="MusicAlbum-position">position: {this.props.position}</div></div>);
            }
        }
                ...
                genre = (
                   <div className='genre-container'>
                       ...
                       {this.props.genre.map((item, index) => {
                           return (<div className='genre' data-advice='Put your HTML here. genre is a Text or URL.'><div className="MusicAlbum-genre">genre: {this.props.genre}</div></div>);
                       })};
                       <div className='genre-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                genre = (<div className='genre' data-advice='Put your HTML here. genre is a Text or URL.'><div className="MusicAlbum-genre">genre: {this.props.genre}</div></div>);
            }
        }
                ...
                schemaVersion = (
                   <div className='schemaVersion-container'>
                       ...
                       {this.props.schemaVersion.map((item, index) => {
                           return (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a Text or URL.'><div className="MusicAlbum-schemaVersion">schemaVersion: {this.props.schemaVersion}</div></div>);
                       })};
                       <div className='schemaVersion-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                schemaVersion = (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a Text or URL.'><div className="MusicAlbum-schemaVersion">schemaVersion: {this.props.schemaVersion}</div></div>);
            }
        }
                ...
                license = (
                   <div className='license-container'>
                       ...
                       {this.props.license.map((item, index) => {
                           return (<div className='license' data-advice='Put your HTML here. license is a URL or CreativeWork.'><div className="MusicAlbum-license">license: {this.props.license}</div></div>);
                       })};
                       <div className='license-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                license = (<div className='license' data-advice='Put your HTML here. license is a URL or CreativeWork.'><div className="MusicAlbum-license">license: {this.props.license}</div></div>);
            }
        }
                ...
                inLanguage = (
                   <div className='inLanguage-container'>
                       ...
                       {this.props.inLanguage.map((item, index) => {
                           return (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text or Language.'><div className="MusicAlbum-inLanguage">inLanguage: {this.props.inLanguage}</div></div>);
                       })};
                       <div className='inLanguage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                inLanguage = (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text or Language.'><div className="MusicAlbum-inLanguage">inLanguage: {this.props.inLanguage}</div></div>);
            }
        }
