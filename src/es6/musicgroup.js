                ...
                sameAs = (
                   <div className='sameAs-container'>
                       ...
                       {this.props.sameAs.map((item, index) => {
                           return (<div className='sameAs' data-advice='Put your HTML here. sameAs is a URL.'><a className="MusicGroup-sameAs" href={this.props.sameAs} target="_blank">sameAs</a></div>);
                       })};
                       <div className='sameAs-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                sameAs = (<div className='sameAs' data-advice='Put your HTML here. sameAs is a URL.'><a className="MusicGroup-sameAs" href={this.props.sameAs} target="_blank">sameAs</a></div>);
            }
        }
                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="MusicGroup-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="MusicGroup-image" src={this.props.image} /></div>);
            }
        }
                ...
                foundingDate = (
                   <div className='foundingDate-container'>
                       ...
                       {this.props.foundingDate.map((item, index) => {
                           return (<div className='foundingDate' data-advice='Put your HTML here. foundingDate is a Date.'><time className="MusicGroup-foundingDate">foundingDate: {this.props.foundingDate}</time></div>);
                       })};
                       <div className='foundingDate-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                foundingDate = (<div className='foundingDate' data-advice='Put your HTML here. foundingDate is a Date.'><time className="MusicGroup-foundingDate">foundingDate: {this.props.foundingDate}</time></div>);
            }
        }
                ...
                telephone = (
                   <div className='telephone-container'>
                       ...
                       {this.props.telephone.map((item, index) => {
                           return (<div className='telephone' data-advice='Put your HTML here. telephone is a Text.'><p className="MusicGroup-telephone">telephone: {this.props.telephone}</p></div>);
                       })};
                       <div className='telephone-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                telephone = (<div className='telephone' data-advice='Put your HTML here. telephone is a Text.'><p className="MusicGroup-telephone">telephone: {this.props.telephone}</p></div>);
            }
        }
                ...
                faxNumber = (
                   <div className='faxNumber-container'>
                       ...
                       {this.props.faxNumber.map((item, index) => {
                           return (<div className='faxNumber' data-advice='Put your HTML here. faxNumber is a Text.'><p className="MusicGroup-faxNumber">faxNumber: {this.props.faxNumber}</p></div>);
                       })};
                       <div className='faxNumber-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                faxNumber = (<div className='faxNumber' data-advice='Put your HTML here. faxNumber is a Text.'><p className="MusicGroup-faxNumber">faxNumber: {this.props.faxNumber}</p></div>);
            }
        }
                ...
                additionalType = (
                   <div className='additionalType-container'>
                       ...
                       {this.props.additionalType.map((item, index) => {
                           return (<div className='additionalType' data-advice='Put your HTML here. additionalType is a URL.'><a className="MusicGroup-additionalType" href={this.props.additionalType} target="_blank">additionalType</a></div>);
                       })};
                       <div className='additionalType-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                additionalType = (<div className='additionalType' data-advice='Put your HTML here. additionalType is a URL.'><a className="MusicGroup-additionalType" href={this.props.additionalType} target="_blank">additionalType</a></div>);
            }
        }
                ...
                logo = (
                   <div className='logo-container'>
                       ...
                       {this.props.logo.map((item, index) => {
                           return (<div className='logo' data-advice='Put your HTML here. logo is a ImageObject or URL.'><div className="MusicGroup-logo">logo: {this.props.logo}</div></div>);
                       })};
                       <div className='logo-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                logo = (<div className='logo' data-advice='Put your HTML here. logo is a ImageObject or URL.'><div className="MusicGroup-logo">logo: {this.props.logo}</div></div>);
            }
        }
            ...
            if (this.props.album instanceof Array) {
                album = (
                   <div className='album-container'>
                       <div className='album-header' data-advice='HTML for the *head* of the section'>albums</div>
                       {this.props.album.map((item, index) => {
                           return (<MusicAlbum key={index} {...this.props.album} />);
                       })};
                       <div className='album-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                album = (<MusicAlbum  {...this.props.album} />);
            }
        }
                ...
                taxID = (
                   <div className='taxID-container'>
                       ...
                       {this.props.taxID.map((item, index) => {
                           return (<div className='taxID' data-advice='Put your HTML here. taxID is a Text.'><p className="MusicGroup-taxID">taxID: {this.props.taxID}</p></div>);
                       })};
                       <div className='taxID-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                taxID = (<div className='taxID' data-advice='Put your HTML here. taxID is a Text.'><p className="MusicGroup-taxID">taxID: {this.props.taxID}</p></div>);
            }
        }
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a CreativeWork or URL.'><div className="MusicGroup-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a CreativeWork or URL.'><div className="MusicGroup-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
                ...
                member = (
                   <div className='member-container'>
                       ...
                       {this.props.member.map((item, index) => {
                           return (<div className='member' data-advice='Put your HTML here. member is a Person or Organization.'><div className="MusicGroup-member">member: {this.props.member}</div></div>);
                       })};
                       <div className='member-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                member = (<div className='member' data-advice='Put your HTML here. member is a Person or Organization.'><div className="MusicGroup-member">member: {this.props.member}</div></div>);
            }
        }
                ...
                location = (
                   <div className='location-container'>
                       ...
                       {this.props.location.map((item, index) => {
                           return (<div className='location' data-advice='Put your HTML here. location is a Place or Text or PostalAddress.'><div className="MusicGroup-location">location: {this.props.location}</div></div>);
                       })};
                       <div className='location-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                location = (<div className='location' data-advice='Put your HTML here. location is a Place or Text or PostalAddress.'><div className="MusicGroup-location">location: {this.props.location}</div></div>);
            }
        }
                ...
                email = (
                   <div className='email-container'>
                       ...
                       {this.props.email.map((item, index) => {
                           return (<div className='email' data-advice='Put your HTML here. email is a Text.'><p className="MusicGroup-email">email: {this.props.email}</p></div>);
                       })};
                       <div className='email-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                email = (<div className='email' data-advice='Put your HTML here. email is a Text.'><p className="MusicGroup-email">email: {this.props.email}</p></div>);
            }
        }
                ...
                isicV4 = (
                   <div className='isicV4-container'>
                       ...
                       {this.props.isicV4.map((item, index) => {
                           return (<div className='isicV4' data-advice='Put your HTML here. isicV4 is a Text.'><p className="MusicGroup-isicV4">isicV4: {this.props.isicV4}</p></div>);
                       })};
                       <div className='isicV4-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                isicV4 = (<div className='isicV4' data-advice='Put your HTML here. isicV4 is a Text.'><p className="MusicGroup-isicV4">isicV4: {this.props.isicV4}</p></div>);
            }
        }
                ...
                description = (
                   <div className='description-container'>
                       ...
                       {this.props.description.map((item, index) => {
                           return (<div className='description' data-advice='Put your HTML here. description is a Text.'><p className="MusicGroup-description">description: {this.props.description}</p></div>);
                       })};
                       <div className='description-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                description = (<div className='description' data-advice='Put your HTML here. description is a Text.'><p className="MusicGroup-description">description: {this.props.description}</p></div>);
            }
        }
                ...
                track = (
                   <div className='track-container'>
                       ...
                       {this.props.track.map((item, index) => {
                           return (<div className='track' data-advice='Put your HTML here. track is a ItemList or MusicRecording.'><div className="MusicGroup-track">track: {this.props.track}</div></div>);
                       })};
                       <div className='track-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                track = (<div className='track' data-advice='Put your HTML here. track is a ItemList or MusicRecording.'><div className="MusicGroup-track">track: {this.props.track}</div></div>);
            }
        }
                ...
                brand = (
                   <div className='brand-container'>
                       ...
                       {this.props.brand.map((item, index) => {
                           return (<div className='brand' data-advice='Put your HTML here. brand is a Organization or Brand.'><div className="MusicGroup-brand">brand: {this.props.brand}</div></div>);
                       })};
                       <div className='brand-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                brand = (<div className='brand' data-advice='Put your HTML here. brand is a Organization or Brand.'><div className="MusicGroup-brand">brand: {this.props.brand}</div></div>);
            }
        }
                ...
                owns = (
                   <div className='owns-container'>
                       ...
                       {this.props.owns.map((item, index) => {
                           return (<div className='owns' data-advice='Put your HTML here. owns is a Product or OwnershipInfo.'><div className="MusicGroup-owns">owns: {this.props.owns}</div></div>);
                       })};
                       <div className='owns-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                owns = (<div className='owns' data-advice='Put your HTML here. owns is a Product or OwnershipInfo.'><div className="MusicGroup-owns">owns: {this.props.owns}</div></div>);
            }
        }
                ...
                award = (
                   <div className='award-container'>
                       ...
                       {this.props.award.map((item, index) => {
                           return (<div className='award' data-advice='Put your HTML here. award is a Text.'><p className="MusicGroup-award">award: {this.props.award}</p></div>);
                       })};
                       <div className='award-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                award = (<div className='award' data-advice='Put your HTML here. award is a Text.'><p className="MusicGroup-award">award: {this.props.award}</p></div>);
            }
        }
                ...
                dissolutionDate = (
                   <div className='dissolutionDate-container'>
                       ...
                       {this.props.dissolutionDate.map((item, index) => {
                           return (<div className='dissolutionDate' data-advice='Put your HTML here. dissolutionDate is a Date.'><time className="MusicGroup-dissolutionDate">dissolutionDate: {this.props.dissolutionDate}</time></div>);
                       })};
                       <div className='dissolutionDate-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                dissolutionDate = (<div className='dissolutionDate' data-advice='Put your HTML here. dissolutionDate is a Date.'><time className="MusicGroup-dissolutionDate">dissolutionDate: {this.props.dissolutionDate}</time></div>);
            }
        }
                ...
                alternateName = (
                   <div className='alternateName-container'>
                       ...
                       {this.props.alternateName.map((item, index) => {
                           return (<div className='alternateName' data-advice='Put your HTML here. alternateName is a Text.'><p className="MusicGroup-alternateName">alternateName: {this.props.alternateName}</p></div>);
                       })};
                       <div className='alternateName-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                alternateName = (<div className='alternateName' data-advice='Put your HTML here. alternateName is a Text.'><p className="MusicGroup-alternateName">alternateName: {this.props.alternateName}</p></div>);
            }
        }
                ...
                address = (
                   <div className='address-container'>
                       ...
                       {this.props.address.map((item, index) => {
                           return (<div className='address' data-advice='Put your HTML here. address is a Text or PostalAddress.'><div className="MusicGroup-address">address: {this.props.address}</div></div>);
                       })};
                       <div className='address-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                address = (<div className='address' data-advice='Put your HTML here. address is a Text or PostalAddress.'><div className="MusicGroup-address">address: {this.props.address}</div></div>);
            }
        }
                ...
                duns = (
                   <div className='duns-container'>
                       ...
                       {this.props.duns.map((item, index) => {
                           return (<div className='duns' data-advice='Put your HTML here. duns is a Text.'><p className="MusicGroup-duns">duns: {this.props.duns}</p></div>);
                       })};
                       <div className='duns-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                duns = (<div className='duns' data-advice='Put your HTML here. duns is a Text.'><p className="MusicGroup-duns">duns: {this.props.duns}</p></div>);
            }
        }
                ...
                name = (
                   <div className='name-container'>
                       ...
                       {this.props.name.map((item, index) => {
                           return (<div className='name' data-advice='Put your HTML here. name is a Text.'><p className="MusicGroup-name">name: {this.props.name}</p></div>);
                       })};
                       <div className='name-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                name = (<div className='name' data-advice='Put your HTML here. name is a Text.'><p className="MusicGroup-name">name: {this.props.name}</p></div>);
            }
        }
                ...
                naics = (
                   <div className='naics-container'>
                       ...
                       {this.props.naics.map((item, index) => {
                           return (<div className='naics' data-advice='Put your HTML here. naics is a Text.'><p className="MusicGroup-naics">naics: {this.props.naics}</p></div>);
                       })};
                       <div className='naics-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                naics = (<div className='naics' data-advice='Put your HTML here. naics is a Text.'><p className="MusicGroup-naics">naics: {this.props.naics}</p></div>);
            }
        }
                ...
                url = (
                   <div className='url-container'>
                       ...
                       {this.props.url.map((item, index) => {
                           return (<div className='url' data-advice='Put your HTML here. url is a URL.'><a className="MusicGroup-url" href={this.props.url} target="_blank">url</a></div>);
                       })};
                       <div className='url-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                url = (<div className='url' data-advice='Put your HTML here. url is a URL.'><a className="MusicGroup-url" href={this.props.url} target="_blank">url</a></div>);
            }
        }
                ...
                memberOf = (
                   <div className='memberOf-container'>
                       ...
                       {this.props.memberOf.map((item, index) => {
                           return (<div className='memberOf' data-advice='Put your HTML here. memberOf is a Organization or ProgramMembership.'><div className="MusicGroup-memberOf">memberOf: {this.props.memberOf}</div></div>);
                       })};
                       <div className='memberOf-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                memberOf = (<div className='memberOf' data-advice='Put your HTML here. memberOf is a Organization or ProgramMembership.'><div className="MusicGroup-memberOf">memberOf: {this.props.memberOf}</div></div>);
            }
        }
                ...
                areaServed = (
                   <div className='areaServed-container'>
                       ...
                       {this.props.areaServed.map((item, index) => {
                           return (<div className='areaServed' data-advice='Put your HTML here. areaServed is a AdministrativeArea or Place or Text or GeoShape.'><div className="MusicGroup-areaServed">areaServed: {this.props.areaServed}</div></div>);
                       })};
                       <div className='areaServed-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                areaServed = (<div className='areaServed' data-advice='Put your HTML here. areaServed is a AdministrativeArea or Place or Text or GeoShape.'><div className="MusicGroup-areaServed">areaServed: {this.props.areaServed}</div></div>);
            }
        }
                ...
                legalName = (
                   <div className='legalName-container'>
                       ...
                       {this.props.legalName.map((item, index) => {
                           return (<div className='legalName' data-advice='Put your HTML here. legalName is a Text.'><p className="MusicGroup-legalName">legalName: {this.props.legalName}</p></div>);
                       })};
                       <div className='legalName-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                legalName = (<div className='legalName' data-advice='Put your HTML here. legalName is a Text.'><p className="MusicGroup-legalName">legalName: {this.props.legalName}</p></div>);
            }
        }
                ...
                vatID = (
                   <div className='vatID-container'>
                       ...
                       {this.props.vatID.map((item, index) => {
                           return (<div className='vatID' data-advice='Put your HTML here. vatID is a Text.'><p className="MusicGroup-vatID">vatID: {this.props.vatID}</p></div>);
                       })};
                       <div className='vatID-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                vatID = (<div className='vatID' data-advice='Put your HTML here. vatID is a Text.'><p className="MusicGroup-vatID">vatID: {this.props.vatID}</p></div>);
            }
        }
                ...
                genre = (
                   <div className='genre-container'>
                       ...
                       {this.props.genre.map((item, index) => {
                           return (<div className='genre' data-advice='Put your HTML here. genre is a Text or URL.'><div className="MusicGroup-genre">genre: {this.props.genre}</div></div>);
                       })};
                       <div className='genre-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                genre = (<div className='genre' data-advice='Put your HTML here. genre is a Text or URL.'><div className="MusicGroup-genre">genre: {this.props.genre}</div></div>);
            }
        }
                ...
                globalLocationNumber = (
                   <div className='globalLocationNumber-container'>
                       ...
                       {this.props.globalLocationNumber.map((item, index) => {
                           return (<div className='globalLocationNumber' data-advice='Put your HTML here. globalLocationNumber is a Text.'><p className="MusicGroup-globalLocationNumber">globalLocationNumber: {this.props.globalLocationNumber}</p></div>);
                       })};
                       <div className='globalLocationNumber-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                globalLocationNumber = (<div className='globalLocationNumber' data-advice='Put your HTML here. globalLocationNumber is a Text.'><p className="MusicGroup-globalLocationNumber">globalLocationNumber: {this.props.globalLocationNumber}</p></div>);
            }
        }
