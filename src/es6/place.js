/* Place - Entities that have a somewhat fixed, physical extension.. Generated automatically by the reactGenerator. */
                ...
                sameAs = (
                   <div className='sameAs-container'>
                       ...
                       {this.props.sameAs.map((item, index) => {
                           return (<div className='sameAs' data-advice='Put your HTML here. sameAs is a URL.'><a className="Place-sameAs" href={this.props.sameAs} target="_blank">sameAs</a></div>);
                       })};
                       <div className='sameAs-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                sameAs = (<div className='sameAs' data-advice='Put your HTML here. sameAs is a URL.'><a className="Place-sameAs" href={this.props.sameAs} target="_blank">sameAs</a></div>);
            }
        }
                ...
                photo = (
                   <div className='photo-container'>
                       ...
                       {this.props.photo.map((item, index) => {
                           return (<div className='photo' data-advice='Put your HTML here. photo is a Photograph or ImageObject.'><div className="Place-photo">photo: {this.props.photo}</div></div>);
                       })};
                       <div className='photo-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                photo = (<div className='photo' data-advice='Put your HTML here. photo is a Photograph or ImageObject.'><div className="Place-photo">photo: {this.props.photo}</div></div>);
            }
        }
                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="Place-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="Place-image" src={this.props.image} /></div>);
            }
        }
                ...
                telephone = (
                   <div className='telephone-container'>
                       ...
                       {this.props.telephone.map((item, index) => {
                           return (<div className='telephone' data-advice='Put your HTML here. telephone is a Text.'><p className="Place-telephone">telephone: {this.props.telephone}</p></div>);
                       })};
                       <div className='telephone-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                telephone = (<div className='telephone' data-advice='Put your HTML here. telephone is a Text.'><p className="Place-telephone">telephone: {this.props.telephone}</p></div>);
            }
        }
                ...
                faxNumber = (
                   <div className='faxNumber-container'>
                       ...
                       {this.props.faxNumber.map((item, index) => {
                           return (<div className='faxNumber' data-advice='Put your HTML here. faxNumber is a Text.'><p className="Place-faxNumber">faxNumber: {this.props.faxNumber}</p></div>);
                       })};
                       <div className='faxNumber-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                faxNumber = (<div className='faxNumber' data-advice='Put your HTML here. faxNumber is a Text.'><p className="Place-faxNumber">faxNumber: {this.props.faxNumber}</p></div>);
            }
        }
                ...
                logo = (
                   <div className='logo-container'>
                       ...
                       {this.props.logo.map((item, index) => {
                           return (<div className='logo' data-advice='Put your HTML here. logo is a URL or ImageObject.'><div className="Place-logo">logo: {this.props.logo}</div></div>);
                       })};
                       <div className='logo-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                logo = (<div className='logo' data-advice='Put your HTML here. logo is a URL or ImageObject.'><div className="Place-logo">logo: {this.props.logo}</div></div>);
            }
        }
                ...
                additionalType = (
                   <div className='additionalType-container'>
                       ...
                       {this.props.additionalType.map((item, index) => {
                           return (<div className='additionalType' data-advice='Put your HTML here. additionalType is a URL.'><a className="Place-additionalType" href={this.props.additionalType} target="_blank">additionalType</a></div>);
                       })};
                       <div className='additionalType-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                additionalType = (<div className='additionalType' data-advice='Put your HTML here. additionalType is a URL.'><a className="Place-additionalType" href={this.props.additionalType} target="_blank">additionalType</a></div>);
            }
        }
                ...
                isicV4 = (
                   <div className='isicV4-container'>
                       ...
                       {this.props.isicV4.map((item, index) => {
                           return (<div className='isicV4' data-advice='Put your HTML here. isicV4 is a Text.'><p className="Place-isicV4">isicV4: {this.props.isicV4}</p></div>);
                       })};
                       <div className='isicV4-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                isicV4 = (<div className='isicV4' data-advice='Put your HTML here. isicV4 is a Text.'><p className="Place-isicV4">isicV4: {this.props.isicV4}</p></div>);
            }
        }
                ...
                geo = (
                   <div className='geo-container'>
                       ...
                       {this.props.geo.map((item, index) => {
                           return (<div className='geo' data-advice='Put your HTML here. geo is a GeoCoordinates or GeoShape.'><div className="Place-geo">geo: {this.props.geo}</div></div>);
                       })};
                       <div className='geo-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                geo = (<div className='geo' data-advice='Put your HTML here. geo is a GeoCoordinates or GeoShape.'><div className="Place-geo">geo: {this.props.geo}</div></div>);
            }
        }
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="Place-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="Place-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
                ...
                description = (
                   <div className='description-container'>
                       ...
                       {this.props.description.map((item, index) => {
                           return (<div className='description' data-advice='Put your HTML here. description is a Text.'><p className="Place-description">description: {this.props.description}</p></div>);
                       })};
                       <div className='description-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                description = (<div className='description' data-advice='Put your HTML here. description is a Text.'><p className="Place-description">description: {this.props.description}</p></div>);
            }
        }
                ...
                address = (
                   <div className='address-container'>
                       ...
                       {this.props.address.map((item, index) => {
                           return (<div className='address' data-advice='Put your HTML here. address is a Text or PostalAddress.'><div className="Place-address">address: {this.props.address}</div></div>);
                       })};
                       <div className='address-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                address = (<div className='address' data-advice='Put your HTML here. address is a Text or PostalAddress.'><div className="Place-address">address: {this.props.address}</div></div>);
            }
        }
                ...
                alternateName = (
                   <div className='alternateName-container'>
                       ...
                       {this.props.alternateName.map((item, index) => {
                           return (<div className='alternateName' data-advice='Put your HTML here. alternateName is a Text.'><p className="Place-alternateName">alternateName: {this.props.alternateName}</p></div>);
                       })};
                       <div className='alternateName-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                alternateName = (<div className='alternateName' data-advice='Put your HTML here. alternateName is a Text.'><p className="Place-alternateName">alternateName: {this.props.alternateName}</p></div>);
            }
        }
                ...
                hasMap = (
                   <div className='hasMap-container'>
                       ...
                       {this.props.hasMap.map((item, index) => {
                           return (<div className='hasMap' data-advice='Put your HTML here. hasMap is a Map or URL.'><div className="Place-hasMap">hasMap: {this.props.hasMap}</div></div>);
                       })};
                       <div className='hasMap-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                hasMap = (<div className='hasMap' data-advice='Put your HTML here. hasMap is a Map or URL.'><div className="Place-hasMap">hasMap: {this.props.hasMap}</div></div>);
            }
        }
                ...
                branchCode = (
                   <div className='branchCode-container'>
                       ...
                       {this.props.branchCode.map((item, index) => {
                           return (<div className='branchCode' data-advice='Put your HTML here. branchCode is a Text.'><p className="Place-branchCode">branchCode: {this.props.branchCode}</p></div>);
                       })};
                       <div className='branchCode-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                branchCode = (<div className='branchCode' data-advice='Put your HTML here. branchCode is a Text.'><p className="Place-branchCode">branchCode: {this.props.branchCode}</p></div>);
            }
        }
                ...
                name = (
                   <div className='name-container'>
                       ...
                       {this.props.name.map((item, index) => {
                           return (<div className='name' data-advice='Put your HTML here. name is a Text.'><p className="Place-name">name: {this.props.name}</p></div>);
                       })};
                       <div className='name-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                name = (<div className='name' data-advice='Put your HTML here. name is a Text.'><p className="Place-name">name: {this.props.name}</p></div>);
            }
        }
                ...
                url = (
                   <div className='url-container'>
                       ...
                       {this.props.url.map((item, index) => {
                           return (<div className='url' data-advice='Put your HTML here. url is a URL.'><a className="Place-url" href={this.props.url} target="_blank">url</a></div>);
                       })};
                       <div className='url-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                url = (<div className='url' data-advice='Put your HTML here. url is a URL.'><a className="Place-url" href={this.props.url} target="_blank">url</a></div>);
            }
        }
                ...
                globalLocationNumber = (
                   <div className='globalLocationNumber-container'>
                       ...
                       {this.props.globalLocationNumber.map((item, index) => {
                           return (<div className='globalLocationNumber' data-advice='Put your HTML here. globalLocationNumber is a Text.'><p className="Place-globalLocationNumber">globalLocationNumber: {this.props.globalLocationNumber}</p></div>);
                       })};
                       <div className='globalLocationNumber-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                globalLocationNumber = (<div className='globalLocationNumber' data-advice='Put your HTML here. globalLocationNumber is a Text.'><p className="Place-globalLocationNumber">globalLocationNumber: {this.props.globalLocationNumber}</p></div>);
            }
        }
