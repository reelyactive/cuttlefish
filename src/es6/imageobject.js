        ...
        if (this.props.representativeOfPage) {
            if (this.props.representativeOfPage instanceof Array) {
                representativeOfPage = (
                   <div className='representativeOfPage__container'>
                       <div className='representativeOfPage__header' data-advice='HTML for the *head* of the section'>representativeOfPages</div>
                       ...
                       <div className='representativeOfPage__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
...
ImageObject.propTypes = {
   ...
   representativeOfPage: React.PropTypes.object,
