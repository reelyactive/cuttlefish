    ...
    render() {
        ...
        if (this.props.inLanguage) {
            if (this.props.inLanguage instanceof Array) {
               ...
               if (this.props['@type'] === 'Text') {
                   inLanguage = (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text.'><p className="ImageObject-inLanguage">inLanguage: {this.props.inLanguage}</p></div>);
               }
               else if (this.props['@type'] === 'Language') {
        ...
        if (this.props.image) {
            if (this.props.image instanceof Array) {
               ...
               if (this.props['@type'] === 'ImageObject') {
                   ...
                   image = (<div className='image' data-advice='Put your HTML here. image is a URL.'><img className="ImageObject-image" src={this.props.image} /></div>);
               }
            }
        }
        ...
        if (this.props.citation) {
            if (this.props.citation instanceof Array) {
               ...
               if (this.props['@type'] === 'CreativeWork') {
                   ...
                   citation = (<div className='citation' data-advice='Put your HTML here. citation is a Text.'><p className="ImageObject-citation">citation: {this.props.citation}</p></div>);
               }
            }
        }
        ...
        if (this.props.mainEntityOfPage) {
            if (this.props.mainEntityOfPage instanceof Array) {
               ...
               if (this.props['@type'] === 'CreativeWork') {
                   ...
                   mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL.'><a className="ImageObject-mainEntityOfPage" href={this.props.mainEntityOfPage} target="_blank">mainEntityOfPage</a></div>);
               }
            }
        }
        ...
        if (this.props.thumbnail) {
            if (this.props.thumbnail instanceof Array) {
                ...
                thumbnail = (<ImageObject key={index} {...this.props.thumbnail} />);
            }
        }
        ...
        if (this.props.exifData) {
            if (this.props.exifData instanceof Array) {
               ...
               if (this.props['@type'] === 'PropertyValue') {
                   exifData = (<PropertyValue key={index} {...this.props.exifData} />);
               }
               else if (this.props['@type'] === 'Text') {
                   exifData = (<div className='exifData' data-advice='Put your HTML here. exifData is a Text.'><p className="ImageObject-exifData">exifData: {this.props.exifData}</p></div>);
               }
            }
        }
        ...
        if (this.props.dateCreated) {
            if (this.props.dateCreated instanceof Array) {
               ...
               if (this.props['@type'] === 'Date') {
                   dateCreated = (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a Date.'><time className="ImageObject-dateCreated">dateCreated: {this.props.dateCreated}</time></div>);
               }
               else if (this.props['@type'] === 'DateTime') {
                   dateCreated = (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a DateTime.'><time className="ImageObject-dateCreated">dateCreated: {this.props.dateCreated}</time></div>);
               }
            }
        }
        ...
        if (this.props.position) {
            if (this.props.position instanceof Array) {
               ...
               if (this.props['@type'] === 'Integer') {
                   position = (<div className='position' data-advice='Put your HTML here. position is a Integer.'><p className="ImageObject-position">position: {this.props.position}</p></div>);
               }
               else if (this.props['@type'] === 'Text') {
                   position = (<div className='position' data-advice='Put your HTML here. position is a Text.'><p className="ImageObject-position">position: {this.props.position}</p></div>);
               }
            }
        }
        ...
        if (this.props.genre) {
            if (this.props.genre instanceof Array) {
               ...
               if (this.props['@type'] === 'Text') {
                   genre = (<div className='genre' data-advice='Put your HTML here. genre is a Text.'><p className="ImageObject-genre">genre: {this.props.genre}</p></div>);
               }
               else if (this.props['@type'] === 'URL') {
                   genre = (<div className='genre' data-advice='Put your HTML here. genre is a URL.'><a className="ImageObject-genre" href={this.props.genre} target="_blank">genre</a></div>);
               }
            }
        }
        ...
        if (this.props.schemaVersion) {
            if (this.props.schemaVersion instanceof Array) {
               ...
               if (this.props['@type'] === 'Text') {
                   schemaVersion = (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a Text.'><p className="ImageObject-schemaVersion">schemaVersion: {this.props.schemaVersion}</p></div>);
               }
               else if (this.props['@type'] === 'URL') {
                   schemaVersion = (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a URL.'><a className="ImageObject-schemaVersion" href={this.props.schemaVersion} target="_blank">schemaVersion</a></div>);
               }
            }
        }
        ...
        if (this.props.license) {
            if (this.props.license instanceof Array) {
               ...
               if (this.props['@type'] === 'CreativeWork') {
                   ...
                   license = (<div className='license' data-advice='Put your HTML here. license is a URL.'><a className="ImageObject-license" href={this.props.license} target="_blank">license</a></div>);
               }
            }
        }
        ...
        if (this.props.dateModified) {
            if (this.props.dateModified instanceof Array) {
               ...
               if (this.props['@type'] === 'Date') {
                   dateModified = (<div className='dateModified' data-advice='Put your HTML here. dateModified is a Date.'><time className="ImageObject-dateModified">dateModified: {this.props.dateModified}</time></div>);
               }
               else if (this.props['@type'] === 'DateTime') {
                   dateModified = (<div className='dateModified' data-advice='Put your HTML here. dateModified is a DateTime.'><time className="ImageObject-dateModified">dateModified: {this.props.dateModified}</time></div>);
               }
            }
        }
