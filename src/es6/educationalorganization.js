                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="EducationalOrganization-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="EducationalOrganization-image" src={this.props.image} /></div>);
            }
        }
                ...
                logo = (
                   <div className='logo-container'>
                       ...
                       {this.props.logo.map((item, index) => {
                           return (<div className='logo' data-advice='Put your HTML here. logo is a URL or ImageObject.'><div className="EducationalOrganization-logo">logo: {this.props.logo}</div></div>);
                       })};
                       <div className='logo-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                logo = (<div className='logo' data-advice='Put your HTML here. logo is a URL or ImageObject.'><div className="EducationalOrganization-logo">logo: {this.props.logo}</div></div>);
            }
        }
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="EducationalOrganization-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="EducationalOrganization-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
                ...
                member = (
                   <div className='member-container'>
                       ...
                       {this.props.member.map((item, index) => {
                           return (<div className='member' data-advice='Put your HTML here. member is a Organization or Person.'><div className="EducationalOrganization-member">member: {this.props.member}</div></div>);
                       })};
                       <div className='member-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                member = (<div className='member' data-advice='Put your HTML here. member is a Organization or Person.'><div className="EducationalOrganization-member">member: {this.props.member}</div></div>);
            }
        }
                ...
                location = (
                   <div className='location-container'>
                       ...
                       {this.props.location.map((item, index) => {
                           return (<div className='location' data-advice='Put your HTML here. location is a Place or Text or PostalAddress.'><div className="EducationalOrganization-location">location: {this.props.location}</div></div>);
                       })};
                       <div className='location-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                location = (<div className='location' data-advice='Put your HTML here. location is a Place or Text or PostalAddress.'><div className="EducationalOrganization-location">location: {this.props.location}</div></div>);
            }
        }
                ...
                brand = (
                   <div className='brand-container'>
                       ...
                       {this.props.brand.map((item, index) => {
                           return (<div className='brand' data-advice='Put your HTML here. brand is a Organization or Brand.'><div className="EducationalOrganization-brand">brand: {this.props.brand}</div></div>);
                       })};
                       <div className='brand-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                brand = (<div className='brand' data-advice='Put your HTML here. brand is a Organization or Brand.'><div className="EducationalOrganization-brand">brand: {this.props.brand}</div></div>);
            }
        }
                ...
                owns = (
                   <div className='owns-container'>
                       ...
                       {this.props.owns.map((item, index) => {
                           return (<div className='owns' data-advice='Put your HTML here. owns is a Product or OwnershipInfo.'><div className="EducationalOrganization-owns">owns: {this.props.owns}</div></div>);
                       })};
                       <div className='owns-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                owns = (<div className='owns' data-advice='Put your HTML here. owns is a Product or OwnershipInfo.'><div className="EducationalOrganization-owns">owns: {this.props.owns}</div></div>);
            }
        }
                ...
                address = (
                   <div className='address-container'>
                       ...
                       {this.props.address.map((item, index) => {
                           return (<div className='address' data-advice='Put your HTML here. address is a Text or PostalAddress.'><div className="EducationalOrganization-address">address: {this.props.address}</div></div>);
                       })};
                       <div className='address-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                address = (<div className='address' data-advice='Put your HTML here. address is a Text or PostalAddress.'><div className="EducationalOrganization-address">address: {this.props.address}</div></div>);
            }
        }
                ...
                memberOf = (
                   <div className='memberOf-container'>
                       ...
                       {this.props.memberOf.map((item, index) => {
                           return (<div className='memberOf' data-advice='Put your HTML here. memberOf is a Organization or ProgramMembership.'><div className="EducationalOrganization-memberOf">memberOf: {this.props.memberOf}</div></div>);
                       })};
                       <div className='memberOf-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                memberOf = (<div className='memberOf' data-advice='Put your HTML here. memberOf is a Organization or ProgramMembership.'><div className="EducationalOrganization-memberOf">memberOf: {this.props.memberOf}</div></div>);
            }
        }
                ...
                areaServed = (
                   <div className='areaServed-container'>
                       ...
                       {this.props.areaServed.map((item, index) => {
                           return (<div className='areaServed' data-advice='Put your HTML here. areaServed is a AdministrativeArea or Place or GeoShape or Text.'><div className="EducationalOrganization-areaServed">areaServed: {this.props.areaServed}</div></div>);
                       })};
                       <div className='areaServed-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                areaServed = (<div className='areaServed' data-advice='Put your HTML here. areaServed is a AdministrativeArea or Place or GeoShape or Text.'><div className="EducationalOrganization-areaServed">areaServed: {this.props.areaServed}</div></div>);
            }
        }
