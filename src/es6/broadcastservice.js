    ...
    render() {
                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="BroadcastService-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="BroadcastService-image" src={this.props.image} /></div>);
            }
        }
                ...
                category = (
                   <div className='category-container'>
                       ...
                       {this.props.category.map((item, index) => {
                           return (<div className='category' data-advice='Put your HTML here. category is a Thing or PhysicalActivityCategory or Text.'><div className="BroadcastService-category">category: {this.props.category}</div></div>);
                       })};
                       <div className='category-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                category = (<div className='category' data-advice='Put your HTML here. category is a Thing or PhysicalActivityCategory or Text.'><div className="BroadcastService-category">category: {this.props.category}</div></div>);
            }
        }
        ...
        if (this.props.broadcastDisplayName) {
            if (this.props.broadcastDisplayName instanceof Array) {
                broadcastDisplayName = (
                   <div className='broadcastDisplayName-container'>
                       <div className='broadcastDisplayName-header' data-advice='HTML for the *head* of the section'>broadcastDisplayNames</div>
                       ...
                       <div className='broadcastDisplayName-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                ...
                provider = (
                   <div className='provider-container'>
                       ...
                       {this.props.provider.map((item, index) => {
                           return (<div className='provider' data-advice='Put your HTML here. provider is a Person or Organization.'><div className="BroadcastService-provider">provider: {this.props.provider}</div></div>);
                       })};
                       <div className='provider-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                provider = (<div className='provider' data-advice='Put your HTML here. provider is a Person or Organization.'><div className="BroadcastService-provider">provider: {this.props.provider}</div></div>);
            }
        }
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a CreativeWork or URL.'><div className="BroadcastService-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a CreativeWork or URL.'><div className="BroadcastService-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
        ...
        if (this.props.videoFormat) {
            if (this.props.videoFormat instanceof Array) {
                videoFormat = (
                   <div className='videoFormat-container'>
                       <div className='videoFormat-header' data-advice='HTML for the *head* of the section'>videoFormats</div>
                       ...
                       <div className='videoFormat-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
        ...
        if (this.props.broadcastTimezone) {
            if (this.props.broadcastTimezone instanceof Array) {
                broadcastTimezone = (
                   <div className='broadcastTimezone-container'>
                       <div className='broadcastTimezone-header' data-advice='HTML for the *head* of the section'>broadcastTimezones</div>
                       ...
                       <div className='broadcastTimezone-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                ...
                areaServed = (
                   <div className='areaServed-container'>
                       ...
                       {this.props.areaServed.map((item, index) => {
                           return (<div className='areaServed' data-advice='Put your HTML here. areaServed is a AdministrativeArea or Place or Text or GeoShape.'><div className="BroadcastService-areaServed">areaServed: {this.props.areaServed}</div></div>);
                       })};
                       <div className='areaServed-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                areaServed = (<div className='areaServed' data-advice='Put your HTML here. areaServed is a AdministrativeArea or Place or Text or GeoShape.'><div className="BroadcastService-areaServed">areaServed: {this.props.areaServed}</div></div>);
            }
        }
...
BroadcastService.propTypes = {
   ...
   broadcastTimezone: React.propTypes.string,
