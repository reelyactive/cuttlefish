    ...
    render() {
        ...
        if (this.props.image) {
            if (this.props.image instanceof Array) {
                   ...
                   <div className='image__container'>
                       ...
                       {this.props.image.map((item, index) => {
                           if (this.props['@type'] === 'ImageObject') {
                               ...
                               return (<div className='image' data-advice='Put your HTML here. image is a URL.'><img className="Organization-image" src={this.props.image} /></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'ImageObject') {
                   ...
                   image = (<div className='image' data-advice='Put your HTML here. image is a URL.'><img className="Organization-image" src={this.props.image} /></div>);
               }
            }
        }
        ...
        if (this.props.logo) {
            if (this.props.logo instanceof Array) {
                   ...
                   <div className='logo__container'>
                       ...
                       {this.props.logo.map((item, index) => {
                           if (this.props['@type'] === 'ImageObject') {
                               ...
                               return (<div className='logo' data-advice='Put your HTML here. logo is a URL.'><a className="Organization-logo" href={this.props.logo} target="_blank">logo</a></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'ImageObject') {
                   ...
                   logo = (<div className='logo' data-advice='Put your HTML here. logo is a URL.'><a className="Organization-logo" href={this.props.logo} target="_blank">logo</a></div>);
               }
            }
        }
        ...
        if (this.props.mainEntityOfPage) {
            if (this.props.mainEntityOfPage instanceof Array) {
                   ...
                   <div className='mainEntityOfPage__container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           if (this.props['@type'] === 'CreativeWork') {
                               ...
                               return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL.'><a className="Organization-mainEntityOfPage" href={this.props.mainEntityOfPage} target="_blank">mainEntityOfPage</a></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'CreativeWork') {
                   ...
                   mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL.'><a className="Organization-mainEntityOfPage" href={this.props.mainEntityOfPage} target="_blank">mainEntityOfPage</a></div>);
               }
            }
        }
        ...
        if (this.props.location) {
            if (this.props.location instanceof Array) {
                   ...
                   <div className='location__container'>
                       ...
                       {this.props.location.map((item, index) => {
                           if (this.props['@type'] === 'Place') {
                               ...
                               return (<div className='location' data-advice='Put your HTML here. location is a Text.'><p className="Organization-location">location: {this.props.location}</p></div>);
                           }
               ...
               if (this.props['@type'] === 'Place') {
                   ...
                   location = (<div className='location' data-advice='Put your HTML here. location is a Text.'><p className="Organization-location">location: {this.props.location}</p></div>);
               }
               else if (this.props['@type'] === 'PostalAddress') {
        ...
        if (this.props.address) {
            if (this.props.address instanceof Array) {
                   ...
                   <div className='address__container'>
                       ...
                       {this.props.address.map((item, index) => {
                           if (this.props['@type'] === 'Text') {
                               return (<div className='address' data-advice='Put your HTML here. address is a Text.'><p className="Organization-address">address: {this.props.address}</p></div>);
                           }
                           else if (this.props['@type'] === 'PostalAddress') {
               ...
               if (this.props['@type'] === 'Text') {
                   address = (<div className='address' data-advice='Put your HTML here. address is a Text.'><p className="Organization-address">address: {this.props.address}</p></div>);
               }
               else if (this.props['@type'] === 'PostalAddress') {
        ...
        if (this.props.areaServed) {
            if (this.props.areaServed instanceof Array) {
                   ...
                   <div className='areaServed__container'>
                       ...
                       {this.props.areaServed.map((item, index) => {
                           if (this.props['@type'] === 'AdministrativeArea') {
                               ...
                               return (<div className='areaServed' data-advice='Put your HTML here. areaServed is a Text.'><p className="Organization-areaServed">areaServed: {this.props.areaServed}</p></div>);
                           }
               ...
               if (this.props['@type'] === 'AdministrativeArea') {
                   ...
                   areaServed = (<div className='areaServed' data-advice='Put your HTML here. areaServed is a Text.'><p className="Organization-areaServed">areaServed: {this.props.areaServed}</p></div>);
               }
               else if (this.props['@type'] === 'GeoShape') {
