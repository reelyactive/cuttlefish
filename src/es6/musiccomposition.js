    ...
    render() {
            ...
            if (this.props.lyrics instanceof Array) {
                lyrics = (
                   <div className='lyrics__container'>
                       <div className='lyrics__header' data-advice='HTML for the *head* of the section'>lyricss</div>
                       {this.props.lyrics.map((item, index) => {
                            return (<CreativeWork  {...this.props.lyrics} />);
                       })}
                       <div className='lyrics__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.dateCreated) {
            if (this.props.dateCreated instanceof Array) {
                   ...
                   <div className='dateCreated__container'>
                       ...
                       {this.props.dateCreated.map((item, index) => {
                           if (this.props['@type'] === 'Date') {
                               return (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a Date.'><time className="MusicComposition-dateCreated">dateCreated: {this.props.dateCreated}</time></div>);
                           }
                           else if (this.props['@type'] === 'DateTime') {
                               return (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a DateTime.'><time className="MusicComposition-dateCreated">dateCreated: {this.props.dateCreated}</time></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'Date') {
                   dateCreated = (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a Date.'><time className="MusicComposition-dateCreated">dateCreated: {this.props.dateCreated}</time></div>);
               }
               else if (this.props['@type'] === 'DateTime') {
                   dateCreated = (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a DateTime.'><time className="MusicComposition-dateCreated">dateCreated: {this.props.dateCreated}</time></div>);
               }
            }
        }
        ...
        if (this.props.genre) {
            if (this.props.genre instanceof Array) {
                   ...
                   <div className='genre__container'>
                       ...
                       {this.props.genre.map((item, index) => {
                           if (this.props['@type'] === 'URL') {
                               return (<div className='genre' data-advice='Put your HTML here. genre is a URL.'><a className="MusicComposition-genre" href={this.props.genre} target="_blank">genre</a></div>);
                           }
                           else if (this.props['@type'] === 'Text') {
                               return (<div className='genre' data-advice='Put your HTML here. genre is a Text.'><p className="MusicComposition-genre">genre: {this.props.genre}</p></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'URL') {
                   genre = (<div className='genre' data-advice='Put your HTML here. genre is a URL.'><a className="MusicComposition-genre" href={this.props.genre} target="_blank">genre</a></div>);
               }
               else if (this.props['@type'] === 'Text') {
                   genre = (<div className='genre' data-advice='Put your HTML here. genre is a Text.'><p className="MusicComposition-genre">genre: {this.props.genre}</p></div>);
               }
            }
        }
        ...
        if (this.props.license) {
            if (this.props.license instanceof Array) {
                license = (
                   <div className='license__container'>
                       ...
                       {this.props.license.map((item, index) => {
                           if (this.props['@type'] === 'URL') {
                               return (<div className='license' data-advice='Put your HTML here. license is a URL.'><a className="MusicComposition-license" href={this.props.license} target="_blank">license</a></div>);
                           }
               ...
               if (this.props['@type'] === 'URL') {
                   license = (<div className='license' data-advice='Put your HTML here. license is a URL.'><a className="MusicComposition-license" href={this.props.license} target="_blank">license</a></div>);
               }
               else if (this.props['@type'] === 'CreativeWork') {
        ...
        if (this.props.includedComposition) {
            if (this.props.includedComposition instanceof Array) {
                includedComposition = (
                   <div className='includedComposition__container'>
                       <div className='includedComposition__header' data-advice='HTML for the *head* of the section'>includedCompositions</div>
                       {this.props.includedComposition.map((item, index) => {
                            return (<MusicComposition  {...this.props.includedComposition} />);
                       })}
                       <div className='includedComposition__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.musicArrangement) {
            if (this.props.musicArrangement instanceof Array) {
                musicArrangement = (
                   <div className='musicArrangement__container'>
                       <div className='musicArrangement__header' data-advice='HTML for the *head* of the section'>musicArrangements</div>
                       {this.props.musicArrangement.map((item, index) => {
                            return (<MusicComposition  {...this.props.musicArrangement} />);
                       })}
                       <div className='musicArrangement__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.image) {
            if (this.props.image instanceof Array) {
                   ...
                   <div className='image__container'>
                       ...
                       {this.props.image.map((item, index) => {
                           if (this.props['@type'] === 'ImageObject') {
                               ...
                               return (<div className='image' data-advice='Put your HTML here. image is a URL.'><img className="MusicComposition-image" src={this.props.image} /></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'ImageObject') {
                   ...
                   image = (<div className='image' data-advice='Put your HTML here. image is a URL.'><img className="MusicComposition-image" src={this.props.image} /></div>);
               }
            }
        }
        ...
        if (this.props.lyricist) {
            if (this.props.lyricist instanceof Array) {
                lyricist = (
                   <div className='lyricist__container'>
                       <div className='lyricist__header' data-advice='HTML for the *head* of the section'>lyricists</div>
                       {this.props.lyricist.map((item, index) => {
                            return (<Person  {...this.props.lyricist} />);
                       })}
                       <div className='lyricist__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.musicCompositionForm) {
            if (this.props.musicCompositionForm instanceof Array) {
                musicCompositionForm = (
                   <div className='musicCompositionForm__container'>
                       <div className='musicCompositionForm__header' data-advice='HTML for the *head* of the section'>musicCompositionForms</div>
                       ...
                       <div className='musicCompositionForm__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
            ...
            if (this.props.composer instanceof Array) {
                composer = (
                   <div className='composer__container'>
                       <div className='composer__header' data-advice='HTML for the *head* of the section'>composers</div>
                       {this.props.composer.map((item, index) => {
                           if (this.props['@type'] === 'Person') {
                               return (<Person key={index} {...this.props.composer} />);
                           }
                           else if (this.props['@type'] === 'Organization') {
                               return (<Organization key={index} {...this.props.composer} />);
                           }
                       })}
                       <div className='composer__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
               if (this.props['@type'] === 'Person') {
                   composer = (<Person key={index} {...this.props.composer} />);
               }
               else if (this.props['@type'] === 'Organization') {
                   composer = (<Organization key={index} {...this.props.composer} />);
               }
            }
        }
        ...
        if (this.props.schemaVersion) {
            if (this.props.schemaVersion instanceof Array) {
                schemaVersion = (
                   <div className='schemaVersion__container'>
                       ...
                       {this.props.schemaVersion.map((item, index) => {
                           if (this.props['@type'] === 'URL') {
                               return (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a URL.'><a className="MusicComposition-schemaVersion" href={this.props.schemaVersion} target="_blank">schemaVersion</a></div>);
                           }
                           else if (this.props['@type'] === 'Text') {
                               return (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a Text.'><p className="MusicComposition-schemaVersion">schemaVersion: {this.props.schemaVersion}</p></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'URL') {
                   schemaVersion = (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a URL.'><a className="MusicComposition-schemaVersion" href={this.props.schemaVersion} target="_blank">schemaVersion</a></div>);
               }
               else if (this.props['@type'] === 'Text') {
                   schemaVersion = (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a Text.'><p className="MusicComposition-schemaVersion">schemaVersion: {this.props.schemaVersion}</p></div>);
               }
            }
        }
        ...
        if (this.props.mainEntityOfPage) {
            if (this.props.mainEntityOfPage instanceof Array) {
                mainEntityOfPage = (
                   <div className='mainEntityOfPage__container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           if (this.props['@type'] === 'URL') {
                               return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL.'><a className="MusicComposition-mainEntityOfPage" href={this.props.mainEntityOfPage} target="_blank">mainEntityOfPage</a></div>);
                           }
                           else if (this.props['@type'] === 'CreativeWork') {
               ...
               if (this.props['@type'] === 'URL') {
                   mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL.'><a className="MusicComposition-mainEntityOfPage" href={this.props.mainEntityOfPage} target="_blank">mainEntityOfPage</a></div>);
               }
               else if (this.props['@type'] === 'CreativeWork') {
        ...
        if (this.props.recordedAs) {
            if (this.props.recordedAs instanceof Array) {
                recordedAs = (
                   <div className='recordedAs__container'>
                       <div className='recordedAs__header' data-advice='HTML for the *head* of the section'>recordedAss</div>
                       {this.props.recordedAs.map((item, index) => {
                            return (<MusicRecording  {...this.props.recordedAs} />);
                       })}
                       <div className='recordedAs__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.firstPerformance) {
            if (this.props.firstPerformance instanceof Array) {
                firstPerformance = (
                   <div className='firstPerformance__container'>
                       <div className='firstPerformance__header' data-advice='HTML for the *head* of the section'>firstPerformances</div>
                       {this.props.firstPerformance.map((item, index) => {
                            return (<Event  {...this.props.firstPerformance} />);
                       })}
                       <div className='firstPerformance__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.inLanguage) {
            if (this.props.inLanguage instanceof Array) {
                   ...
                   <div className='inLanguage__container'>
                       ...
                       {this.props.inLanguage.map((item, index) => {
                           if (this.props['@type'] === 'Language') {
                               ...
                               return (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text.'><p className="MusicComposition-inLanguage">inLanguage: {this.props.inLanguage}</p></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'Language') {
                   ...
                   inLanguage = (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text.'><p className="MusicComposition-inLanguage">inLanguage: {this.props.inLanguage}</p></div>);
               }
            }
        }
        ...
        if (this.props.iswcCode) {
            if (this.props.iswcCode instanceof Array) {
                iswcCode = (
                   <div className='iswcCode__container'>
                       <div className='iswcCode__header' data-advice='HTML for the *head* of the section'>iswcCodes</div>
                       ...
                       <div className='iswcCode__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.citation) {
            if (this.props.citation instanceof Array) {
                   ...
                   <div className='citation__container'>
                       ...
                       {this.props.citation.map((item, index) => {
                           if (this.props['@type'] === 'CreativeWork') {
                               ...
                               return (<div className='citation' data-advice='Put your HTML here. citation is a Text.'><p className="MusicComposition-citation">citation: {this.props.citation}</p></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'CreativeWork') {
                   ...
                   citation = (<div className='citation' data-advice='Put your HTML here. citation is a Text.'><p className="MusicComposition-citation">citation: {this.props.citation}</p></div>);
               }
            }
        }
        ...
        if (this.props.musicalKey) {
            if (this.props.musicalKey instanceof Array) {
                musicalKey = (
                   <div className='musicalKey__container'>
                       <div className='musicalKey__header' data-advice='HTML for the *head* of the section'>musicalKeys</div>
                       ...
                       <div className='musicalKey__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.dateModified) {
            if (this.props.dateModified instanceof Array) {
                dateModified = (
                   <div className='dateModified__container'>
                       ...
                       {this.props.dateModified.map((item, index) => {
                           if (this.props['@type'] === 'Date') {
                               return (<div className='dateModified' data-advice='Put your HTML here. dateModified is a Date.'><time className="MusicComposition-dateModified">dateModified: {this.props.dateModified}</time></div>);
                           }
                           else if (this.props['@type'] === 'DateTime') {
                               return (<div className='dateModified' data-advice='Put your HTML here. dateModified is a DateTime.'><time className="MusicComposition-dateModified">dateModified: {this.props.dateModified}</time></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'Date') {
                   dateModified = (<div className='dateModified' data-advice='Put your HTML here. dateModified is a Date.'><time className="MusicComposition-dateModified">dateModified: {this.props.dateModified}</time></div>);
               }
               else if (this.props['@type'] === 'DateTime') {
                   dateModified = (<div className='dateModified' data-advice='Put your HTML here. dateModified is a DateTime.'><time className="MusicComposition-dateModified">dateModified: {this.props.dateModified}</time></div>);
               }
            }
        }
        ...
        if (this.props.position) {
            if (this.props.position instanceof Array) {
                   ...
                   <div className='position__container'>
                       ...
                       {this.props.position.map((item, index) => {
                           if (this.props['@type'] === 'Integer') {
                               return (<div className='position' data-advice='Put your HTML here. position is a Integer.'><p className="MusicComposition-position">position: {this.props.position}</p></div>);
                           }
                           else if (this.props['@type'] === 'Text') {
                               return (<div className='position' data-advice='Put your HTML here. position is a Text.'><p className="MusicComposition-position">position: {this.props.position}</p></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'Integer') {
                   position = (<div className='position' data-advice='Put your HTML here. position is a Integer.'><p className="MusicComposition-position">position: {this.props.position}</p></div>);
               }
               else if (this.props['@type'] === 'Text') {
                   position = (<div className='position' data-advice='Put your HTML here. position is a Text.'><p className="MusicComposition-position">position: {this.props.position}</p></div>);
               }
            }
        }
...
MusicComposition.propTypes = {
   ...
   musicCompositionForm: React.PropTypes.object,
