    ...
    render() {
        ...
        if (this.props.isAccessibleForFree) {
            if (this.props.isAccessibleForFree instanceof Array) {
                isAccessibleForFree = (
                   <div className='isAccessibleForFree__container'>
                       <div className='isAccessibleForFree__header' data-advice='HTML for the *head* of the section'>isAccessibleForFrees</div>
                       ...
                       <div className='isAccessibleForFree__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.publishedOn) {
            if (this.props.publishedOn instanceof Array) {
                publishedOn = (
                   <div className='publishedOn__container'>
                       <div className='publishedOn__header' data-advice='HTML for the *head* of the section'>publishedOns</div>
                       {this.props.publishedOn.map((item, index) => {
                            return (<BroadcastService  {...this.props.publishedOn} />);
                       })}
                       <div className='publishedOn__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
...
PublicationEvent.propTypes = {
   ...
   isAccessibleForFree: React.PropTypes.object,
