    ...
    render() {
                ...
                producer = (
                   <div className='producer-container'>
                       ...
                       {this.props.producer.map((item, index) => {
                           return (<div className='producer' data-advice='Put your HTML here. producer is a Person or Organization.'><div className="VideoObject-producer">producer: {this.props.producer}</div></div>);
                       })};
                       <div className='producer-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                producer = (<div className='producer' data-advice='Put your HTML here. producer is a Person or Organization.'><div className="VideoObject-producer">producer: {this.props.producer}</div></div>);
            }
        }
                ...
                dateCreated = (
                   <div className='dateCreated-container'>
                       ...
                       {this.props.dateCreated.map((item, index) => {
                           return (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a Date or DateTime.'><div className="VideoObject-dateCreated">dateCreated: {this.props.dateCreated}</div></div>);
                       })};
                       <div className='dateCreated-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                dateCreated = (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a Date or DateTime.'><div className="VideoObject-dateCreated">dateCreated: {this.props.dateCreated}</div></div>);
            }
        }
        ...
        if (this.props.videoQuality) {
            if (this.props.videoQuality instanceof Array) {
                videoQuality = (
                   <div className='videoQuality-container'>
                       <div className='videoQuality-header' data-advice='HTML for the *head* of the section'>videoQualitys</div>
                       ...
                       <div className='videoQuality-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                ...
                creator = (
                   <div className='creator-container'>
                       ...
                       {this.props.creator.map((item, index) => {
                           return (<div className='creator' data-advice='Put your HTML here. creator is a Person or Organization.'><div className="VideoObject-creator">creator: {this.props.creator}</div></div>);
                       })};
                       <div className='creator-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                creator = (<div className='creator' data-advice='Put your HTML here. creator is a Person or Organization.'><div className="VideoObject-creator">creator: {this.props.creator}</div></div>);
            }
        }
        ...
        if (this.props.musicBy) {
            if (this.props.musicBy instanceof Array) {
                musicBy = (
                   <div className='musicBy-container'>
                       <div className='musicBy-header' data-advice='HTML for the *head* of the section'>musicBys</div>
                       {this.props.musicBy.map((item, index) => {
                           return (<div className='musicBy' data-advice='Put your HTML here. musicBy is a MusicGroup or Person.'><div className="VideoObject-musicBy">musicBy: {this.props.musicBy}</div></div>);
                       })};
                       <div className='musicBy-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                musicBy = (<div className='musicBy' data-advice='Put your HTML here. musicBy is a MusicGroup or Person.'><div className="VideoObject-musicBy">musicBy: {this.props.musicBy}</div></div>);
            }
        }
                ...
                provider = (
                   <div className='provider-container'>
                       ...
                       {this.props.provider.map((item, index) => {
                           return (<div className='provider' data-advice='Put your HTML here. provider is a Person or Organization.'><div className="VideoObject-provider">provider: {this.props.provider}</div></div>);
                       })};
                       <div className='provider-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                provider = (<div className='provider' data-advice='Put your HTML here. provider is a Person or Organization.'><div className="VideoObject-provider">provider: {this.props.provider}</div></div>);
            }
        }
                ...
                genre = (
                   <div className='genre-container'>
                       ...
                       {this.props.genre.map((item, index) => {
                           return (<div className='genre' data-advice='Put your HTML here. genre is a Text or URL.'><div className="VideoObject-genre">genre: {this.props.genre}</div></div>);
                       })};
                       <div className='genre-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                genre = (<div className='genre' data-advice='Put your HTML here. genre is a Text or URL.'><div className="VideoObject-genre">genre: {this.props.genre}</div></div>);
            }
        }
                ...
                publisher = (
                   <div className='publisher-container'>
                       ...
                       {this.props.publisher.map((item, index) => {
                           return (<div className='publisher' data-advice='Put your HTML here. publisher is a Person or Organization.'><div className="VideoObject-publisher">publisher: {this.props.publisher}</div></div>);
                       })};
                       <div className='publisher-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                publisher = (<div className='publisher' data-advice='Put your HTML here. publisher is a Person or Organization.'><div className="VideoObject-publisher">publisher: {this.props.publisher}</div></div>);
            }
        }
                ...
                translator = (
                   <div className='translator-container'>
                       ...
                       {this.props.translator.map((item, index) => {
                           return (<div className='translator' data-advice='Put your HTML here. translator is a Person or Organization.'><div className="VideoObject-translator">translator: {this.props.translator}</div></div>);
                       })};
                       <div className='translator-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                translator = (<div className='translator' data-advice='Put your HTML here. translator is a Person or Organization.'><div className="VideoObject-translator">translator: {this.props.translator}</div></div>);
            }
        }
                ...
                license = (
                   <div className='license-container'>
                       ...
                       {this.props.license.map((item, index) => {
                           return (<div className='license' data-advice='Put your HTML here. license is a URL or CreativeWork.'><div className="VideoObject-license">license: {this.props.license}</div></div>);
                       })};
                       <div className='license-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                license = (<div className='license' data-advice='Put your HTML here. license is a URL or CreativeWork.'><div className="VideoObject-license">license: {this.props.license}</div></div>);
            }
        }
                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="VideoObject-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="VideoObject-image" src={this.props.image} /></div>);
            }
        }
                ...
                height = (
                   <div className='height-container'>
                       ...
                       {this.props.height.map((item, index) => {
                           return (<div className='height' data-advice='Put your HTML here. height is a QuantitativeValue or Distance.'><div className="VideoObject-height">height: {this.props.height}</div></div>);
                       })};
                       <div className='height-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                height = (<div className='height' data-advice='Put your HTML here. height is a QuantitativeValue or Distance.'><div className="VideoObject-height">height: {this.props.height}</div></div>);
            }
        }
                ...
                contributor = (
                   <div className='contributor-container'>
                       ...
                       {this.props.contributor.map((item, index) => {
                           return (<div className='contributor' data-advice='Put your HTML here. contributor is a Person or Organization.'><div className="VideoObject-contributor">contributor: {this.props.contributor}</div></div>);
                       })};
                       <div className='contributor-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                contributor = (<div className='contributor' data-advice='Put your HTML here. contributor is a Person or Organization.'><div className="VideoObject-contributor">contributor: {this.props.contributor}</div></div>);
            }
        }
                ...
                width = (
                   <div className='width-container'>
                       ...
                       {this.props.width.map((item, index) => {
                           return (<div className='width' data-advice='Put your HTML here. width is a QuantitativeValue or Distance.'><div className="VideoObject-width">width: {this.props.width}</div></div>);
                       })};
                       <div className='width-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                width = (<div className='width' data-advice='Put your HTML here. width is a QuantitativeValue or Distance.'><div className="VideoObject-width">width: {this.props.width}</div></div>);
            }
        }
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="VideoObject-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="VideoObject-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
                ...
                copyrightHolder = (
                   <div className='copyrightHolder-container'>
                       ...
                       {this.props.copyrightHolder.map((item, index) => {
                           return (<div className='copyrightHolder' data-advice='Put your HTML here. copyrightHolder is a Person or Organization.'><div className="VideoObject-copyrightHolder">copyrightHolder: {this.props.copyrightHolder}</div></div>);
                       })};
                       <div className='copyrightHolder-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                copyrightHolder = (<div className='copyrightHolder' data-advice='Put your HTML here. copyrightHolder is a Person or Organization.'><div className="VideoObject-copyrightHolder">copyrightHolder: {this.props.copyrightHolder}</div></div>);
            }
        }
        ...
        if (this.props.videoFrameSize) {
            if (this.props.videoFrameSize instanceof Array) {
                videoFrameSize = (
                   <div className='videoFrameSize-container'>
                       <div className='videoFrameSize-header' data-advice='HTML for the *head* of the section'>videoFrameSizes</div>
                       ...
                       <div className='videoFrameSize-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                ...
                inLanguage = (
                   <div className='inLanguage-container'>
                       ...
                       {this.props.inLanguage.map((item, index) => {
                           return (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text or Language.'><div className="VideoObject-inLanguage">inLanguage: {this.props.inLanguage}</div></div>);
                       })};
                       <div className='inLanguage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                inLanguage = (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text or Language.'><div className="VideoObject-inLanguage">inLanguage: {this.props.inLanguage}</div></div>);
            }
        }
                ...
                citation = (
                   <div className='citation-container'>
                       ...
                       {this.props.citation.map((item, index) => {
                           return (<div className='citation' data-advice='Put your HTML here. citation is a Text or CreativeWork.'><div className="VideoObject-citation">citation: {this.props.citation}</div></div>);
                       })};
                       <div className='citation-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                citation = (<div className='citation' data-advice='Put your HTML here. citation is a Text or CreativeWork.'><div className="VideoObject-citation">citation: {this.props.citation}</div></div>);
            }
        }
                ...
                author = (
                   <div className='author-container'>
                       ...
                       {this.props.author.map((item, index) => {
                           return (<div className='author' data-advice='Put your HTML here. author is a Person or Organization.'><div className="VideoObject-author">author: {this.props.author}</div></div>);
                       })};
                       <div className='author-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                author = (<div className='author' data-advice='Put your HTML here. author is a Person or Organization.'><div className="VideoObject-author">author: {this.props.author}</div></div>);
            }
        }
            ...
            if (this.props.actor instanceof Array) {
                actor = (
                   <div className='actor-container'>
                       <div className='actor-header' data-advice='HTML for the *head* of the section'>actors</div>
                       {this.props.actor.map((item, index) => {
                           return (<Person key={index} {...this.props.actor} />);
                       })};
                       <div className='actor-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                ...
                dateModified = (
                   <div className='dateModified-container'>
                       ...
                       {this.props.dateModified.map((item, index) => {
                           return (<div className='dateModified' data-advice='Put your HTML here. dateModified is a Date or DateTime.'><div className="VideoObject-dateModified">dateModified: {this.props.dateModified}</div></div>);
                       })};
                       <div className='dateModified-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                dateModified = (<div className='dateModified' data-advice='Put your HTML here. dateModified is a Date or DateTime.'><div className="VideoObject-dateModified">dateModified: {this.props.dateModified}</div></div>);
            }
        }
            ...
            if (this.props.director instanceof Array) {
                director = (
                   <div className='director-container'>
                       <div className='director-header' data-advice='HTML for the *head* of the section'>directors</div>
                       {this.props.director.map((item, index) => {
                           return (<Person key={index} {...this.props.director} />);
                       })};
                       <div className='director-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                ...
                schemaVersion = (
                   <div className='schemaVersion-container'>
                       ...
                       {this.props.schemaVersion.map((item, index) => {
                           return (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a Text or URL.'><div className="VideoObject-schemaVersion">schemaVersion: {this.props.schemaVersion}</div></div>);
                       })};
                       <div className='schemaVersion-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                schemaVersion = (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a Text or URL.'><div className="VideoObject-schemaVersion">schemaVersion: {this.props.schemaVersion}</div></div>);
            }
        }
                ...
                position = (
                   <div className='position-container'>
                       ...
                       {this.props.position.map((item, index) => {
                           return (<div className='position' data-advice='Put your HTML here. position is a Text or Integer.'><div className="VideoObject-position">position: {this.props.position}</div></div>);
                       })};
                       <div className='position-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                position = (<div className='position' data-advice='Put your HTML here. position is a Text or Integer.'><div className="VideoObject-position">position: {this.props.position}</div></div>);
            }
        }
...
VideoObject.propTypes = {
   ...
   videoQuality: React.propTypes.string,
   ...
   videoFrameSize: React.propTypes.string,
