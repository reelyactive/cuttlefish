    ...
    render() {
        ...
        if (this.props.image) {
            if (this.props.image instanceof Array) {
                   ...
                   <div className='image__container'>
                       ...
                       {this.props.image.map((item, index) => {
                           if (this.props['@type'] === 'ImageObject') {
                               ...
                               return (<div className='image' data-advice='Put your HTML here. image is a URL.'><img className="Dataset-image" src={this.props.image} /></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'ImageObject') {
                   ...
                   image = (<div className='image' data-advice='Put your HTML here. image is a URL.'><img className="Dataset-image" src={this.props.image} /></div>);
               }
            }
        }
        ...
        if (this.props.citation) {
            if (this.props.citation instanceof Array) {
                   ...
                   <div className='citation__container'>
                       ...
                       {this.props.citation.map((item, index) => {
                           if (this.props['@type'] === 'CreativeWork') {
                               ...
                               return (<div className='citation' data-advice='Put your HTML here. citation is a Text.'><p className="Dataset-citation">citation: {this.props.citation}</p></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'CreativeWork') {
                   ...
                   citation = (<div className='citation' data-advice='Put your HTML here. citation is a Text.'><p className="Dataset-citation">citation: {this.props.citation}</p></div>);
               }
            }
        }
        ...
        if (this.props.mainEntityOfPage) {
            if (this.props.mainEntityOfPage instanceof Array) {
                   ...
                   <div className='mainEntityOfPage__container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           if (this.props['@type'] === 'CreativeWork') {
                               ...
                               return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL.'><a className="Dataset-mainEntityOfPage" href={this.props.mainEntityOfPage} target="_blank">mainEntityOfPage</a></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'CreativeWork') {
                   ...
                   mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL.'><a className="Dataset-mainEntityOfPage" href={this.props.mainEntityOfPage} target="_blank">mainEntityOfPage</a></div>);
               }
            }
        }
        ...
        if (this.props.dateModified) {
            if (this.props.dateModified instanceof Array) {
                   ...
                   <div className='dateModified__container'>
                       ...
                       {this.props.dateModified.map((item, index) => {
                           if (this.props['@type'] === 'Date') {
                               return (<div className='dateModified' data-advice='Put your HTML here. dateModified is a Date.'><time className="Dataset-dateModified">dateModified: {this.props.dateModified}</time></div>);
                           }
                           else if (this.props['@type'] === 'DateTime') {
                               return (<div className='dateModified' data-advice='Put your HTML here. dateModified is a DateTime.'><time className="Dataset-dateModified">dateModified: {this.props.dateModified}</time></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'Date') {
                   dateModified = (<div className='dateModified' data-advice='Put your HTML here. dateModified is a Date.'><time className="Dataset-dateModified">dateModified: {this.props.dateModified}</time></div>);
               }
               else if (this.props['@type'] === 'DateTime') {
                   dateModified = (<div className='dateModified' data-advice='Put your HTML here. dateModified is a DateTime.'><time className="Dataset-dateModified">dateModified: {this.props.dateModified}</time></div>);
               }
            }
        }
        ...
        if (this.props.dateCreated) {
            if (this.props.dateCreated instanceof Array) {
                dateCreated = (
                   <div className='dateCreated__container'>
                       ...
                       {this.props.dateCreated.map((item, index) => {
                           if (this.props['@type'] === 'Date') {
                               return (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a Date.'><time className="Dataset-dateCreated">dateCreated: {this.props.dateCreated}</time></div>);
                           }
                           else if (this.props['@type'] === 'DateTime') {
                               return (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a DateTime.'><time className="Dataset-dateCreated">dateCreated: {this.props.dateCreated}</time></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'Date') {
                   dateCreated = (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a Date.'><time className="Dataset-dateCreated">dateCreated: {this.props.dateCreated}</time></div>);
               }
               else if (this.props['@type'] === 'DateTime') {
                   dateCreated = (<div className='dateCreated' data-advice='Put your HTML here. dateCreated is a DateTime.'><time className="Dataset-dateCreated">dateCreated: {this.props.dateCreated}</time></div>);
               }
            }
        }
        ...
        if (this.props.position) {
            if (this.props.position instanceof Array) {
                   ...
                   <div className='position__container'>
                       ...
                       {this.props.position.map((item, index) => {
                           if (this.props['@type'] === 'Integer') {
                               return (<div className='position' data-advice='Put your HTML here. position is a Integer.'><p className="Dataset-position">position: {this.props.position}</p></div>);
                           }
                           else if (this.props['@type'] === 'Text') {
                               return (<div className='position' data-advice='Put your HTML here. position is a Text.'><p className="Dataset-position">position: {this.props.position}</p></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'Integer') {
                   position = (<div className='position' data-advice='Put your HTML here. position is a Integer.'><p className="Dataset-position">position: {this.props.position}</p></div>);
               }
               else if (this.props['@type'] === 'Text') {
                   position = (<div className='position' data-advice='Put your HTML here. position is a Text.'><p className="Dataset-position">position: {this.props.position}</p></div>);
               }
            }
        }
        ...
        if (this.props.genre) {
            if (this.props.genre instanceof Array) {
                   ...
                   <div className='genre__container'>
                       ...
                       {this.props.genre.map((item, index) => {
                           if (this.props['@type'] === 'Text') {
                               return (<div className='genre' data-advice='Put your HTML here. genre is a Text.'><p className="Dataset-genre">genre: {this.props.genre}</p></div>);
                           }
                           else if (this.props['@type'] === 'URL') {
                               return (<div className='genre' data-advice='Put your HTML here. genre is a URL.'><a className="Dataset-genre" href={this.props.genre} target="_blank">genre</a></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'Text') {
                   genre = (<div className='genre' data-advice='Put your HTML here. genre is a Text.'><p className="Dataset-genre">genre: {this.props.genre}</p></div>);
               }
               else if (this.props['@type'] === 'URL') {
                   genre = (<div className='genre' data-advice='Put your HTML here. genre is a URL.'><a className="Dataset-genre" href={this.props.genre} target="_blank">genre</a></div>);
               }
            }
        }
        ...
        if (this.props.schemaVersion) {
            if (this.props.schemaVersion instanceof Array) {
                schemaVersion = (
                   <div className='schemaVersion__container'>
                       ...
                       {this.props.schemaVersion.map((item, index) => {
                           if (this.props['@type'] === 'Text') {
                               return (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a Text.'><p className="Dataset-schemaVersion">schemaVersion: {this.props.schemaVersion}</p></div>);
                           }
                           else if (this.props['@type'] === 'URL') {
                               return (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a URL.'><a className="Dataset-schemaVersion" href={this.props.schemaVersion} target="_blank">schemaVersion</a></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'Text') {
                   schemaVersion = (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a Text.'><p className="Dataset-schemaVersion">schemaVersion: {this.props.schemaVersion}</p></div>);
               }
               else if (this.props['@type'] === 'URL') {
                   schemaVersion = (<div className='schemaVersion' data-advice='Put your HTML here. schemaVersion is a URL.'><a className="Dataset-schemaVersion" href={this.props.schemaVersion} target="_blank">schemaVersion</a></div>);
               }
            }
        }
        ...
        if (this.props.license) {
            if (this.props.license instanceof Array) {
                   ...
                   <div className='license__container'>
                       ...
                       {this.props.license.map((item, index) => {
                           if (this.props['@type'] === 'CreativeWork') {
                               ...
                               return (<div className='license' data-advice='Put your HTML here. license is a URL.'><a className="Dataset-license" href={this.props.license} target="_blank">license</a></div>);
                           }
                       })}
               ...
               if (this.props['@type'] === 'CreativeWork') {
                   ...
                   license = (<div className='license' data-advice='Put your HTML here. license is a URL.'><a className="Dataset-license" href={this.props.license} target="_blank">license</a></div>);
               }
            }
        }
        ...
        if (this.props.inLanguage) {
            if (this.props.inLanguage instanceof Array) {
                inLanguage = (
                   <div className='inLanguage__container'>
                       ...
                       {this.props.inLanguage.map((item, index) => {
                           if (this.props['@type'] === 'Text') {
                               return (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text.'><p className="Dataset-inLanguage">inLanguage: {this.props.inLanguage}</p></div>);
                           }
               ...
               if (this.props['@type'] === 'Text') {
                   inLanguage = (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text.'><p className="Dataset-inLanguage">inLanguage: {this.props.inLanguage}</p></div>);
               }
               else if (this.props['@type'] === 'Language') {
