                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="ItemList-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="ItemList-image" src={this.props.image} /></div>);
            }
        }
                ...
                itemListOrder = (
                   <div className='itemListOrder-container'>
                       ...
                       {this.props.itemListOrder.map((item, index) => {
                           return (<div className='itemListOrder' data-advice='Put your HTML here. itemListOrder is a ItemListOrderType or Text.'><div className="ItemList-itemListOrder">itemListOrder: {this.props.itemListOrder}</div></div>);
                       })};
                       <div className='itemListOrder-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                itemListOrder = (<div className='itemListOrder' data-advice='Put your HTML here. itemListOrder is a ItemListOrderType or Text.'><div className="ItemList-itemListOrder">itemListOrder: {this.props.itemListOrder}</div></div>);
            }
        }
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="ItemList-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="ItemList-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
                ...
                itemListElement = (
                   <div className='itemListElement-container'>
                       ...
                       {this.props.itemListElement.map((item, index) => {
                           return (<div className='itemListElement' data-advice='Put your HTML here. itemListElement is a ListItem or Thing or Text.'><div className="ItemList-itemListElement">itemListElement: {this.props.itemListElement}</div></div>);
                       })};
                       <div className='itemListElement-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                itemListElement = (<div className='itemListElement' data-advice='Put your HTML here. itemListElement is a ListItem or Thing or Text.'><div className="ItemList-itemListElement">itemListElement: {this.props.itemListElement}</div></div>);
            }
        }
