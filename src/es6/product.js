                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="Product-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="Product-image" src={this.props.image} /></div>);
            }
        }
                ...
                height = (
                   <div className='height-container'>
                       ...
                       {this.props.height.map((item, index) => {
                           return (<div className='height' data-advice='Put your HTML here. height is a Distance or QuantitativeValue.'><div className="Product-height">height: {this.props.height}</div></div>);
                       })};
                       <div className='height-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                height = (<div className='height' data-advice='Put your HTML here. height is a Distance or QuantitativeValue.'><div className="Product-height">height: {this.props.height}</div></div>);
            }
        }
                ...
                logo = (
                   <div className='logo-container'>
                       ...
                       {this.props.logo.map((item, index) => {
                           return (<div className='logo' data-advice='Put your HTML here. logo is a ImageObject or URL.'><div className="Product-logo">logo: {this.props.logo}</div></div>);
                       })};
                       <div className='logo-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                logo = (<div className='logo' data-advice='Put your HTML here. logo is a ImageObject or URL.'><div className="Product-logo">logo: {this.props.logo}</div></div>);
            }
        }
                ...
                category = (
                   <div className='category-container'>
                       ...
                       {this.props.category.map((item, index) => {
                           return (<div className='category' data-advice='Put your HTML here. category is a Thing or PhysicalActivityCategory or Text.'><div className="Product-category">category: {this.props.category}</div></div>);
                       })};
                       <div className='category-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                category = (<div className='category' data-advice='Put your HTML here. category is a Thing or PhysicalActivityCategory or Text.'><div className="Product-category">category: {this.props.category}</div></div>);
            }
        }
                ...
                width = (
                   <div className='width-container'>
                       ...
                       {this.props.width.map((item, index) => {
                           return (<div className='width' data-advice='Put your HTML here. width is a Distance or QuantitativeValue.'><div className="Product-width">width: {this.props.width}</div></div>);
                       })};
                       <div className='width-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                width = (<div className='width' data-advice='Put your HTML here. width is a Distance or QuantitativeValue.'><div className="Product-width">width: {this.props.width}</div></div>);
            }
        }
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a CreativeWork or URL.'><div className="Product-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a CreativeWork or URL.'><div className="Product-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
                ...
                brand = (
                   <div className='brand-container'>
                       ...
                       {this.props.brand.map((item, index) => {
                           return (<div className='brand' data-advice='Put your HTML here. brand is a Organization or Brand.'><div className="Product-brand">brand: {this.props.brand}</div></div>);
                       })};
                       <div className='brand-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                brand = (<div className='brand' data-advice='Put your HTML here. brand is a Organization or Brand.'><div className="Product-brand">brand: {this.props.brand}</div></div>);
            }
        }
                ...
                depth = (
                   <div className='depth-container'>
                       ...
                       {this.props.depth.map((item, index) => {
                           return (<div className='depth' data-advice='Put your HTML here. depth is a Distance or QuantitativeValue.'><div className="Product-depth">depth: {this.props.depth}</div></div>);
                       })};
                       <div className='depth-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                depth = (<div className='depth' data-advice='Put your HTML here. depth is a Distance or QuantitativeValue.'><div className="Product-depth">depth: {this.props.depth}</div></div>);
            }
        }
                ...
                model = (
                   <div className='model-container'>
                       ...
                       {this.props.model.map((item, index) => {
                           return (<div className='model' data-advice='Put your HTML here. model is a ProductModel or Text.'><div className="Product-model">model: {this.props.model}</div></div>);
                       })};
                       <div className='model-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                model = (<div className='model' data-advice='Put your HTML here. model is a ProductModel or Text.'><div className="Product-model">model: {this.props.model}</div></div>);
            }
        }
