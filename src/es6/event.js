                ...
                inLanguage = (
                   <div className='inLanguage-container'>
                       ...
                       {this.props.inLanguage.map((item, index) => {
                           return (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text or Language.'><div className="Event-inLanguage">inLanguage: {this.props.inLanguage}</div></div>);
                       })};
                       <div className='inLanguage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                inLanguage = (<div className='inLanguage' data-advice='Put your HTML here. inLanguage is a Text or Language.'><div className="Event-inLanguage">inLanguage: {this.props.inLanguage}</div></div>);
            }
        }
                ...
                performer = (
                   <div className='performer-container'>
                       ...
                       {this.props.performer.map((item, index) => {
                           return (<div className='performer' data-advice='Put your HTML here. performer is a Person or Organization.'><div className="Event-performer">performer: {this.props.performer}</div></div>);
                       })};
                       <div className='performer-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                performer = (<div className='performer' data-advice='Put your HTML here. performer is a Person or Organization.'><div className="Event-performer">performer: {this.props.performer}</div></div>);
            }
        }
                ...
                organizer = (
                   <div className='organizer-container'>
                       ...
                       {this.props.organizer.map((item, index) => {
                           return (<div className='organizer' data-advice='Put your HTML here. organizer is a Person or Organization.'><div className="Event-organizer">organizer: {this.props.organizer}</div></div>);
                       })};
                       <div className='organizer-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                organizer = (<div className='organizer' data-advice='Put your HTML here. organizer is a Person or Organization.'><div className="Event-organizer">organizer: {this.props.organizer}</div></div>);
            }
        }
                ...
                location = (
                   <div className='location-container'>
                       ...
                       {this.props.location.map((item, index) => {
                           return (<div className='location' data-advice='Put your HTML here. location is a Place or Text or PostalAddress.'><div className="Event-location">location: {this.props.location}</div></div>);
                       })};
                       <div className='location-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                location = (<div className='location' data-advice='Put your HTML here. location is a Place or Text or PostalAddress.'><div className="Event-location">location: {this.props.location}</div></div>);
            }
        }
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="Event-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="Event-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
                ...
                attendee = (
                   <div className='attendee-container'>
                       ...
                       {this.props.attendee.map((item, index) => {
                           return (<div className='attendee' data-advice='Put your HTML here. attendee is a Person or Organization.'><div className="Event-attendee">attendee: {this.props.attendee}</div></div>);
                       })};
                       <div className='attendee-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                attendee = (<div className='attendee' data-advice='Put your HTML here. attendee is a Person or Organization.'><div className="Event-attendee">attendee: {this.props.attendee}</div></div>);
            }
        }
                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a URL or ImageObject.'><img className="Event-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a URL or ImageObject.'><img className="Event-image" src={this.props.image} /></div>);
            }
        }
