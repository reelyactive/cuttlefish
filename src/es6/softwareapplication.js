    ...
    render() {
        ...
        if (this.props.processorRequirements) {
            if (this.props.processorRequirements instanceof Array) {
                processorRequirements = (
                   <div className='processorRequirements__container'>
                       <div className='processorRequirements__header' data-advice='HTML for the *head* of the section'>processorRequirementss</div>
                       ...
                       <div className='processorRequirements__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.countriesNotSupported) {
            if (this.props.countriesNotSupported instanceof Array) {
                countriesNotSupported = (
                   <div className='countriesNotSupported__container'>
                       <div className='countriesNotSupported__header' data-advice='HTML for the *head* of the section'>countriesNotSupporteds</div>
                       ...
                       <div className='countriesNotSupported__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.applicationCategory) {
            if (this.props.applicationCategory instanceof Array) {
                applicationCategory = (
                   <div className='applicationCategory__container'>
                       <div className='applicationCategory__header' data-advice='HTML for the *head* of the section'>applicationCategorys</div>
                       ...
                       <div className='applicationCategory__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
               if (this.props['@type'] === 'Text') {
            ...
            if (this.props.releaseNotes instanceof Array) {
                releaseNotes = (
                   <div className='releaseNotes__container'>
                       <div className='releaseNotes__header' data-advice='HTML for the *head* of the section'>releaseNotess</div>
                       ...
                       <div className='releaseNotes__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
               if (this.props['@type'] === 'Text') {
        ...
        if (this.props.memoryRequirements) {
            if (this.props.memoryRequirements instanceof Array) {
                memoryRequirements = (
                   <div className='memoryRequirements__container'>
                       <div className='memoryRequirements__header' data-advice='HTML for the *head* of the section'>memoryRequirementss</div>
                       ...
                       <div className='memoryRequirements__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
               if (this.props['@type'] === 'Text') {
            ...
            if (this.props.permissions instanceof Array) {
                permissions = (
                   <div className='permissions__container'>
                       <div className='permissions__header' data-advice='HTML for the *head* of the section'>permissionss</div>
                       ...
                       <div className='permissions__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.supportingData) {
            if (this.props.supportingData instanceof Array) {
                supportingData = (
                   <div className='supportingData__container'>
                       <div className='supportingData__header' data-advice='HTML for the *head* of the section'>supportingDatas</div>
                       {this.props.supportingData.map((item, index) => {
                            return (<DataFeed  {...this.props.supportingData} />);
                       })}
                       <div className='supportingData__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.installUrl) {
            if (this.props.installUrl instanceof Array) {
                installUrl = (
                   <div className='installUrl__container'>
                       <div className='installUrl__header' data-advice='HTML for the *head* of the section'>installUrls</div>
                       ...
                       <div className='installUrl__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.applicationSuite) {
            if (this.props.applicationSuite instanceof Array) {
                applicationSuite = (
                   <div className='applicationSuite__container'>
                       <div className='applicationSuite__header' data-advice='HTML for the *head* of the section'>applicationSuites</div>
                       ...
                       <div className='applicationSuite__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.softwareRequirements) {
            if (this.props.softwareRequirements instanceof Array) {
                softwareRequirements = (
                   <div className='softwareRequirements__container'>
                       <div className='softwareRequirements__header' data-advice='HTML for the *head* of the section'>softwareRequirementss</div>
                       ...
                       <div className='softwareRequirements__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
               if (this.props['@type'] === 'Text') {
        ...
        if (this.props.fileSize) {
            if (this.props.fileSize instanceof Array) {
                fileSize = (
                   <div className='fileSize__container'>
                       <div className='fileSize__header' data-advice='HTML for the *head* of the section'>fileSizes</div>
                       ...
                       <div className='fileSize__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.featureList) {
            if (this.props.featureList instanceof Array) {
                featureList = (
                   <div className='featureList__container'>
                       <div className='featureList__header' data-advice='HTML for the *head* of the section'>featureLists</div>
                       ...
                       <div className='featureList__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
               if (this.props['@type'] === 'Text') {
        ...
        if (this.props.softwareVersion) {
            if (this.props.softwareVersion instanceof Array) {
                softwareVersion = (
                   <div className='softwareVersion__container'>
                       <div className='softwareVersion__header' data-advice='HTML for the *head* of the section'>softwareVersions</div>
                       ...
                       <div className='softwareVersion__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
            ...
            if (this.props.downloadUrl instanceof Array) {
                downloadUrl = (
                   <div className='downloadUrl__container'>
                       <div className='downloadUrl__header' data-advice='HTML for the *head* of the section'>downloadUrls</div>
                       ...
                       <div className='downloadUrl__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
            ...
            if (this.props.operatingSystem instanceof Array) {
                operatingSystem = (
                   <div className='operatingSystem__container'>
                       <div className='operatingSystem__header' data-advice='HTML for the *head* of the section'>operatingSystems</div>
                       ...
                       <div className='operatingSystem__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.countriesSupported) {
            if (this.props.countriesSupported instanceof Array) {
                countriesSupported = (
                   <div className='countriesSupported__container'>
                       <div className='countriesSupported__header' data-advice='HTML for the *head* of the section'>countriesSupporteds</div>
                       ...
                       <div className='countriesSupported__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.availableOnDevice) {
            if (this.props.availableOnDevice instanceof Array) {
                availableOnDevice = (
                   <div className='availableOnDevice__container'>
                       <div className='availableOnDevice__header' data-advice='HTML for the *head* of the section'>availableOnDevices</div>
                       ...
                       <div className='availableOnDevice__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.applicationSubCategory) {
            if (this.props.applicationSubCategory instanceof Array) {
                applicationSubCategory = (
                   <div className='applicationSubCategory__container'>
                       <div className='applicationSubCategory__header' data-advice='HTML for the *head* of the section'>applicationSubCategorys</div>
                       ...
                       <div className='applicationSubCategory__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
               if (this.props['@type'] === 'Text') {
        ...
        if (this.props.softwareHelp) {
            if (this.props.softwareHelp instanceof Array) {
                softwareHelp = (
                   <div className='softwareHelp__container'>
                       <div className='softwareHelp__header' data-advice='HTML for the *head* of the section'>softwareHelps</div>
                       {this.props.softwareHelp.map((item, index) => {
                            return (<CreativeWork  {...this.props.softwareHelp} />);
                       })}
                       <div className='softwareHelp__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
            ...
            if (this.props.screenshot instanceof Array) {
                screenshot = (
                   <div className='screenshot__container'>
                       <div className='screenshot__header' data-advice='HTML for the *head* of the section'>screenshots</div>
                       ...
                       <div className='screenshot__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
               if (this.props['@type'] === 'ImageObject') {
        ...
        if (this.props.softwareAddOn) {
            if (this.props.softwareAddOn instanceof Array) {
                softwareAddOn = (
                   <div className='softwareAddOn__container'>
                       <div className='softwareAddOn__header' data-advice='HTML for the *head* of the section'>softwareAddOns</div>
                       {this.props.softwareAddOn.map((item, index) => {
                            return (<SoftwareApplication  {...this.props.softwareAddOn} />);
                       })}
                       <div className='softwareAddOn__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
        ...
        if (this.props.storageRequirements) {
            if (this.props.storageRequirements instanceof Array) {
                storageRequirements = (
                   <div className='storageRequirements__container'>
                       <div className='storageRequirements__header' data-advice='HTML for the *head* of the section'>storageRequirementss</div>
                       ...
                       <div className='storageRequirements__footer' data-advice='HTML for the *footer* of the section'></div>
                   </div>
                );
            } else {
               if (this.props['@type'] === 'Text') {
...
SoftwareApplication.propTypes = {
   ...
   installUrl: React.PropTypes.object,
   ...
   applicationSuite: React.PropTypes.object,
   ...
   fileSize: React.PropTypes.object,
   ...
   softwareVersion: React.PropTypes.object,
