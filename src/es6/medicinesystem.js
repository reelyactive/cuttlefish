/* MedicineSystem - Systems of medical practice.. Generated automatically by the reactGenerator. */
...
export default class MedicineSystem extends Component {
    render() {
        let code;
        if (this.props.code) {
                ...
                description = (
                   <div className='description-container'>
                       ...
                       {this.props.description.map((item, index) => {
                           return (<div className='description' data-advice='Put your HTML here. description is a Text.'><p className="MedicineSystem-description">description: {this.props.description}</p></div>);
                       })};
                       <div className='description-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                description = (<div className='description' data-advice='Put your HTML here. description is a Text.'><p className="MedicineSystem-description">description: {this.props.description}</p></div>);
            }
        }
                ...
                url = (
                   <div className='url-container'>
                       ...
                       {this.props.url.map((item, index) => {
                           return (<div className='url' data-advice='Put your HTML here. url is a URL.'><a className="MedicineSystem-url" href={this.props.url} target="_blank">url</a></div>);
                       })};
                       <div className='url-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                url = (<div className='url' data-advice='Put your HTML here. url is a URL.'><a className="MedicineSystem-url" href={this.props.url} target="_blank">url</a></div>);
            }
        }
                ...
                sameAs = (
                   <div className='sameAs-container'>
                       ...
                       {this.props.sameAs.map((item, index) => {
                           return (<div className='sameAs' data-advice='Put your HTML here. sameAs is a URL.'><a className="MedicineSystem-sameAs" href={this.props.sameAs} target="_blank">sameAs</a></div>);
                       })};
                       <div className='sameAs-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                sameAs = (<div className='sameAs' data-advice='Put your HTML here. sameAs is a URL.'><a className="MedicineSystem-sameAs" href={this.props.sameAs} target="_blank">sameAs</a></div>);
            }
        }
                ...
                supersededBy = (
                   <div className='supersededBy-container'>
                       ...
                       {this.props.supersededBy.map((item, index) => {
                           return (<div className='supersededBy' data-advice='Put your HTML here. supersededBy is a Class or Property or Enumeration.'><div className="MedicineSystem-supersededBy">supersededBy: {this.props.supersededBy}</div></div>);
                       })};
                       <div className='supersededBy-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                supersededBy = (<div className='supersededBy' data-advice='Put your HTML here. supersededBy is a Class or Property or Enumeration.'><div className="MedicineSystem-supersededBy">supersededBy: {this.props.supersededBy}</div></div>);
            }
        }
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="MedicineSystem-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a URL or CreativeWork.'><div className="MedicineSystem-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
                ...
                additionalType = (
                   <div className='additionalType-container'>
                       ...
                       {this.props.additionalType.map((item, index) => {
                           return (<div className='additionalType' data-advice='Put your HTML here. additionalType is a URL.'><a className="MedicineSystem-additionalType" href={this.props.additionalType} target="_blank">additionalType</a></div>);
                       })};
                       <div className='additionalType-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                additionalType = (<div className='additionalType' data-advice='Put your HTML here. additionalType is a URL.'><a className="MedicineSystem-additionalType" href={this.props.additionalType} target="_blank">additionalType</a></div>);
            }
        }
                ...
                alternateName = (
                   <div className='alternateName-container'>
                       ...
                       {this.props.alternateName.map((item, index) => {
                           return (<div className='alternateName' data-advice='Put your HTML here. alternateName is a Text.'><p className="MedicineSystem-alternateName">alternateName: {this.props.alternateName}</p></div>);
                       })};
                       <div className='alternateName-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                alternateName = (<div className='alternateName' data-advice='Put your HTML here. alternateName is a Text.'><p className="MedicineSystem-alternateName">alternateName: {this.props.alternateName}</p></div>);
            }
        }
                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="MedicineSystem-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="MedicineSystem-image" src={this.props.image} /></div>);
            }
        }
                ...
                name = (
                   <div className='name-container'>
                       ...
                       {this.props.name.map((item, index) => {
                           return (<div className='name' data-advice='Put your HTML here. name is a Text.'><p className="MedicineSystem-name">name: {this.props.name}</p></div>);
                       })};
                       <div className='name-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                name = (<div className='name' data-advice='Put your HTML here. name is a Text.'><p className="MedicineSystem-name">name: {this.props.name}</p></div>);
            }
        }

        return (
            <div className='MedicineSystem'>
                {code}
                {description}
                {potentialAction}
                {relevantSpecialty}
