    ...
    render() {
        ...
        if (this.props.codeValue) {
            if (this.props.codeValue instanceof Array) {
                codeValue = (
                   <div className='codeValue-container'>
                       <div className='codeValue-header' data-advice='HTML for the *head* of the section'>codeValues</div>
                       ...
                       <div className='codeValue-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                ...
                mainEntityOfPage = (
                   <div className='mainEntityOfPage-container'>
                       ...
                       {this.props.mainEntityOfPage.map((item, index) => {
                           return (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a CreativeWork or URL.'><div className="MedicalCode-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
                       })};
                       <div className='mainEntityOfPage-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                mainEntityOfPage = (<div className='mainEntityOfPage' data-advice='Put your HTML here. mainEntityOfPage is a CreativeWork or URL.'><div className="MedicalCode-mainEntityOfPage">mainEntityOfPage: {this.props.mainEntityOfPage}</div></div>);
            }
        }
        ...
        if (this.props.codingSystem) {
            if (this.props.codingSystem instanceof Array) {
                codingSystem = (
                   <div className='codingSystem-container'>
                       <div className='codingSystem-header' data-advice='HTML for the *head* of the section'>codingSystems</div>
                       ...
                       <div className='codingSystem-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                ...
                image = (
                   <div className='image-container'>
                       ...
                       {this.props.image.map((item, index) => {
                           return (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="MedicalCode-image" src={this.props.image} /></div>);
                       })};
                       <div className='image-footer' data-advice='HTML for the *footer* of the section'></div>;
                   </div>
                );
            } else {
                image = (<div className='image' data-advice='Put your HTML here. image is a ImageObject or URL.'><img className="MedicalCode-image" src={this.props.image} /></div>);
            }
        }
...
MedicalCode.propTypes = {
   ...
   codingSystem: React.propTypes.string,
