/* Thing > Intangible > StructuredValue - Structured values are used when the value of a property has a more complex structure than simply being a textual value or a reference to another thing.. Generated automatically by the reactGenerator. */  var StructuredValue= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='StructuredValue' className='StructuredValue entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
