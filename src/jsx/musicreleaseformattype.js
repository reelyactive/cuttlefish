/* Thing > Intangible > Enumeration > MusicReleaseFormatType - Format of this release (the type of recording media used, ie. compact disc, digital media, LP, etc.).. Generated automatically by the reactGenerator. */  var MusicReleaseFormatType= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='MusicReleaseFormatType' className='MusicReleaseFormatType entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
