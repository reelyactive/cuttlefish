/* Thing > Intangible > Enumeration > MusicAlbumProductionType - Classification of the album by it's type of content: soundtrack, live album, studio album, etc.. Generated automatically by the reactGenerator. */
      ...
      if( props.supersededBy ){
        if( props.supersededBy instanceof Array ){
          ...
          supersededBy = supersededBy.concat( props.supersededBy.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. supersededBy is a Enumeration or
Class or
Property.'></div> )
           }) );
...
URL.'></div> );
      ...
      return (<div title='MusicAlbumProductionType' className='MusicAlbumProductionType entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
