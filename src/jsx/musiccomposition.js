/* Thing > CreativeWork > MusicComposition - A musical composition.. Generated automatically by the reactGenerator. */  var MusicComposition= React.createClass({
    ...
    render: function(){
      ...
      if( props.musicArrangement ){
        if( props.musicArrangement instanceof Array ){
          musicArrangement = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          musicArrangement = musicArrangement.concat( props.musicArrangement.map( function(result, index){
              return ( <MusicComposition {...result} key={index} /> )
           }) );
         musicArrangement.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          musicArrangement = ( <MusicComposition props={ props.musicArrangement } /> );        }
      }
      var iswcCode;
      if( props.iswcCode ){
        if( props.iswcCode instanceof Array ){
          iswcCode = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          iswcCode = iswcCode.concat( props.iswcCode.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. iswcCode is a Text.'></div> )
           }) );
         iswcCode.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            iswcCode = ( <div data-advice='Put your HTML here. iswcCode is a Text.'></div> );
        }
      }
      var producer;
      if( props.producer ){
...
ImageObject.'></div> );
      ...
      if( props.lyricist ){
        if( props.lyricist instanceof Array ){
          lyricist = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          lyricist = lyricist.concat( props.lyricist.map( function(result, index){
              return ( <Person {...result} key={index} /> )
           }) );
         lyricist.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          lyricist = ( <Person props={ props.lyricist } /> );        }
      }
      var sameAs;
      if( props.sameAs ){
      ...
      if( props.musicCompositionForm ){
        if( props.musicCompositionForm instanceof Array ){
          musicCompositionForm = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          musicCompositionForm = musicCompositionForm.concat( props.musicCompositionForm.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. musicCompositionForm is a Text.'></div> )
           }) );
         musicCompositionForm.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            musicCompositionForm = ( <div data-advice='Put your HTML here. musicCompositionForm is a Text.'></div> );
        }
      }
      var commentCount;
      ...
      if( props.composer ){
        if( props.composer instanceof Array ){
          composer = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          composer = composer.concat( props.composer.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. composer is a Person or
Organization.'></div> )
           }) );
         composer.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            composer = ( <div data-advice='Put your HTML here. composer is a Person or
Organization.'></div> );
        }
      }
      var typicalAgeRange;
...
Organization.'></div> );
      ...
      if( props.musicalKey ){
        if( props.musicalKey instanceof Array ){
          musicalKey = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          musicalKey = musicalKey.concat( props.musicalKey.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. musicalKey is a Text.'></div> )
           }) );
         musicalKey.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            musicalKey = ( <div data-advice='Put your HTML here. musicalKey is a Text.'></div> );
        }
      }
      var isBasedOnUrl;
...
Organization.'></div> );
      ...
      if( props.recordedAs ){
        if( props.recordedAs instanceof Array ){
          recordedAs = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          recordedAs = recordedAs.concat( props.recordedAs.map( function(result, index){
              return ( <MusicRecording {...result} key={index} /> )
           }) );
         recordedAs.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          recordedAs = ( <MusicRecording props={ props.recordedAs } /> );        }
      }
...
Text.'></div> );
      ...
      if( props.firstPerformance ){
        if( props.firstPerformance instanceof Array ){
          firstPerformance = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          firstPerformance = firstPerformance.concat( props.firstPerformance.map( function(result, index){
              return ( <Event {...result} key={index} /> )
           }) );
         firstPerformance.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          firstPerformance = ( <Event props={ props.firstPerformance } /> );        }
      }
      var schemaVersion;
...
Text.'></div> );
      ...
      if( props.includedComposition ){
        if( props.includedComposition instanceof Array ){
          includedComposition = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          includedComposition = includedComposition.concat( props.includedComposition.map( function(result, index){
              return ( <MusicComposition {...result} key={index} /> )
           }) );
         includedComposition.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          includedComposition = ( <MusicComposition props={ props.includedComposition } /> );        }
      }
      var keywords;
      if( props.keywords ){
