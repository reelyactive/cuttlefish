/* Thing > Intangible > Enumeration > EventStatusType - EventStatusType is an enumeration type whose instances represent several states that an Event may be in.. Generated automatically by the reactGenerator. */  var EventStatusType= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='EventStatusType' className='EventStatusType entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
