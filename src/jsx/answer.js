/* Thing > CreativeWork > Comment > Answer - An answer offered to a question; perhaps correct, perhaps opinionated or wrong.. Generated automatically by the reactGenerator. */  var Answer= React.createClass({
...
Text.'></div> );
      ...
      return (<div title='Answer' className='Answer entity'>
        { comment }
        { copyrightYear }
        { version }
        { producer }
