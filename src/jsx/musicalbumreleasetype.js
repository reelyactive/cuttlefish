/* Thing > Intangible > Enumeration > MusicAlbumReleaseType - The kind of release which this album is: single, EP or album.. Generated automatically by the reactGenerator. */  var MusicAlbumReleaseType= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='MusicAlbumReleaseType' className='MusicAlbumReleaseType entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
