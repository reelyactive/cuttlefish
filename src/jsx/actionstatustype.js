/* Thing > Intangible > Enumeration > ActionStatusType - The status of an Action.. Generated automatically by the reactGenerator. */  var ActionStatusType= React.createClass({
...
CreativeWork.'></div> );
      ...
      return (<div title='ActionStatusType' className='ActionStatusType entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
