/* Thing > Intangible > Enumeration > ItemAvailability - A list of possible product availability options.. Generated automatically by the reactGenerator. */  var ItemAvailability= React.createClass({
...
CreativeWork.'></div> );
      ...
      return (<div title='ItemAvailability' className='ItemAvailability entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
