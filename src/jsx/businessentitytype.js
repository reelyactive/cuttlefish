...
http://purl.org/goodrelations/v1#Reseller. Generated automatically by the reactGenerator. */  var BusinessEntityType= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='BusinessEntityType' className='BusinessEntityType entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
