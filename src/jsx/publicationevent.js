...
Organization.'></div> );
      ...
      if( props.isAccessibleForFree ){
        if( props.isAccessibleForFree instanceof Array ){
          isAccessibleForFree = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
         ...
         isAccessibleForFree.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
URL.'></div> );
      ...
      if( props.publishedOn ){
        if( props.publishedOn instanceof Array ){
          publishedOn = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          publishedOn = publishedOn.concat( props.publishedOn.map( function(result, index){
              return ( <BroadcastService {...result} key={index} /> )
           }) );
         publishedOn.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
