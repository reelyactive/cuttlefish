/* Thing > CreativeWork > MediaObject > VideoObject - A video file.. Generated automatically by the reactGenerator. */  var VideoObject= React.createClass({
...
Organization.'></div> );
      ...
      if( props.videoQuality ){
        if( props.videoQuality instanceof Array ){
          videoQuality = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          videoQuality = videoQuality.concat( props.videoQuality.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. videoQuality is a Text.'></div> )
           }) );
         videoQuality.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Organization.'></div> );
      ...
      if( props.musicBy ){
        if( props.musicBy instanceof Array ){
          musicBy = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          musicBy = musicBy.concat( props.musicBy.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. musicBy is a MusicGroup or
Person.'></div> )
           }) );
         musicBy.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Organization.'></div> );
      ...
      if( props.thumbnail ){
        if( props.thumbnail instanceof Array ){
          thumbnail = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          thumbnail = thumbnail.concat( props.thumbnail.map( function(result, index){
              return ( <ImageObject {...result} key={index} /> )
           }) );
         thumbnail.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          thumbnail = ( <ImageObject props={ props.thumbnail } /> );        }
      }
      var contentSize;
      ...
      if( props.director ){
        if( props.director instanceof Array ){
          director = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          director = director.concat( props.director.map( function(result, index){
              return ( <Person {...result} key={index} /> )
           }) );
         director.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          director = ( <Person props={ props.director } /> );        }
      }
      var about;
      if( props.about ){
...
URL.'></div> );
      ...
      if( props.caption ){
        if( props.caption instanceof Array ){
          caption = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          caption = caption.concat( props.caption.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. caption is a Text.'></div> )
           }) );
         caption.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Organization.'></div> );
      ...
      if( props.videoFrameSize ){
        if( props.videoFrameSize instanceof Array ){
          videoFrameSize = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          videoFrameSize = videoFrameSize.concat( props.videoFrameSize.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. videoFrameSize is a Text.'></div> )
           }) );
         videoFrameSize.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Organization.'></div> );
      ...
      if( props.actor ){
        if( props.actor instanceof Array ){
          actor = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          actor = actor.concat( props.actor.map( function(result, index){
              return ( <Person {...result} key={index} /> )
           }) );
         actor.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          actor = ( <Person props={ props.actor } /> );        }
      }
      var dateModified;
...
Text.'></div> );
      ...
      if( props.transcript ){
        if( props.transcript instanceof Array ){
          transcript = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          transcript = transcript.concat( props.transcript.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. transcript is a Text.'></div> )
           }) );
         transcript.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
