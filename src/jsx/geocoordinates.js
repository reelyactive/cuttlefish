/* Thing > Intangible > StructuredValue > GeoCoordinates - The geographic coordinates of a place or event.. Generated automatically by the reactGenerator. */  var GeoCoordinates= React.createClass({
...
ImageObject.'></div> );
      ...
      if( props.longitude ){
        if( props.longitude instanceof Array ){
          longitude = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          longitude = longitude.concat( props.longitude.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. longitude is a Text or
Number.'></div> )
           }) );
         longitude.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            longitude = ( <div data-advice='Put your HTML here. longitude is a Text or
Number.'></div> );
        }
      }
...
CreativeWork.'></div> );
      ...
      if( props.latitude ){
        if( props.latitude instanceof Array ){
          latitude = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          latitude = latitude.concat( props.latitude.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. latitude is a Text or
Number.'></div> )
           }) );
         latitude.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            latitude = ( <div data-advice='Put your HTML here. latitude is a Text or
Number.'></div> );
        }
      }
      var additionalType;
