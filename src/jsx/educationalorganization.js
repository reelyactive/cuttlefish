/* Thing > Organization > EducationalOrganization - An educational organization.. Generated automatically by the reactGenerator. */  var EducationalOrganization= React.createClass({
...
Organization.'></div> );
      ...
      if( props.alumni ){
        if( props.alumni instanceof Array ){
          alumni = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          alumni = alumni.concat( props.alumni.map( function(result, index){
              return ( <Person {...result} key={index} /> )
           }) );
         alumni.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
