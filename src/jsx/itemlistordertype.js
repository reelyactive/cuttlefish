/* Thing > Intangible > Enumeration > ItemListOrderType - Enumerated for values for itemListOrder for indicating how an ordered ItemList is organized.. Generated automatically by the reactGenerator. */  var ItemListOrderType= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='ItemListOrderType' className='ItemListOrderType entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
