/* Thing > Intangible > Enumeration > MedicalEnumeration > PhysicalActivityCategory - Categories of physical activity, organized by physiologic classification.. Generated automatically by the reactGenerator. */  var PhysicalActivityCategory= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='PhysicalActivityCategory' className='PhysicalActivityCategory entity'>
        { code }
        { potentialAction }
        { description }
        { relevantSpecialty }
