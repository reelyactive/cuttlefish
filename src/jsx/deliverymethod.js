...
http://purl.org/goodrelations/v1#UPS. Generated automatically by the reactGenerator. */  var DeliveryMethod= React.createClass({
...
CreativeWork.'></div> );
      ...
      return (<div title='DeliveryMethod' className='DeliveryMethod entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
