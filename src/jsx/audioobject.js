/* Thing > CreativeWork > MediaObject > AudioObject - An audio file.. Generated automatically by the reactGenerator. */
...
Integer.'></div> );
      ...
      return (<div title='AudioObject' className='AudioObject entity'>
        { educationalUse }
        { producer }
        { text }
        { datePublished }
