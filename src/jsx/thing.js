/* Thing - The most generic type of item.. Generated automatically by the reactGenerator. */  var Thing= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='Thing' className='Thing entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
