/* Thing > CreativeWork > MusicPlaylist > MusicRelease - A MusicRelease is a specific release of a music album.. Generated automatically by the reactGenerator. */  var MusicRelease= React.createClass({
    ...
    render: function(){
      ...
      if( props.recordLabel ){
        if( props.recordLabel instanceof Array ){
          recordLabel = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          recordLabel = recordLabel.concat( props.recordLabel.map( function(result, index){
              return ( <Organization {...result} key={index} /> )
           }) );
         recordLabel.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          recordLabel = ( <Organization props={ props.recordLabel } /> );        }
      }
      var version;
      if( props.version ){
...
CreativeWork.'></div> );
      ...
      if( props.catalogNumber ){
        if( props.catalogNumber instanceof Array ){
          catalogNumber = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          catalogNumber = catalogNumber.concat( props.catalogNumber.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. catalogNumber is a Text.'></div> )
           }) );
         catalogNumber.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            catalogNumber = ( <div data-advice='Put your HTML here. catalogNumber is a Text.'></div> );
        }
      }
      var isPartOf;
      if( props.isPartOf ){
      ...
      if( props.releaseOf ){
        if( props.releaseOf instanceof Array ){
          releaseOf = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          releaseOf = releaseOf.concat( props.releaseOf.map( function(result, index){
              return ( <MusicAlbum {...result} key={index} /> )
           }) );
         releaseOf.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          releaseOf = ( <MusicAlbum props={ props.releaseOf } /> );        }
      }
      ...
      if( props.track ){
        if( props.track instanceof Array ){
          track = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          track = track.concat( props.track.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. track is a ItemList or
MusicRecording.'></div> )
           }) );
         track.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Organization.'></div> );
      ...
      if( props.creditedTo ){
        if( props.creditedTo instanceof Array ){
          creditedTo = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          creditedTo = creditedTo.concat( props.creditedTo.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. creditedTo is a Person or
Organization.'></div> )
           }) );
         creditedTo.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            creditedTo = ( <div data-advice='Put your HTML here. creditedTo is a Person or
Organization.'></div> );
        }
      }
      var award;
...
Text.'></div> );
      ...
      if( props.musicReleaseFormat ){
        if( props.musicReleaseFormat instanceof Array ){
          musicReleaseFormat = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          musicReleaseFormat = musicReleaseFormat.concat( props.musicReleaseFormat.map( function(result, index){
              return ( <MusicReleaseFormatType {...result} key={index} /> )
           }) );
         musicReleaseFormat.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          musicReleaseFormat = ( <MusicReleaseFormatType props={ props.musicReleaseFormat } /> );        }
      }
      var name;
      if( props.name ){
...
CreativeWork.'></div> );
      ...
      if( props.numTracks ){
        if( props.numTracks instanceof Array ){
          numTracks = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          numTracks = numTracks.concat( props.numTracks.map( function(result, index){
              return ( <Integer {...result} key={index} /> )
           }) );
         numTracks.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Text.'></div> );
      ...
      return (<div title='MusicRelease' className='MusicRelease entity'>
        { comment }
        { copyrightYear }
        { hasPart }
        { recordLabel }
