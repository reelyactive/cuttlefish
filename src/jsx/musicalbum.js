/* Thing > CreativeWork > MusicPlaylist > MusicAlbum - A collection of music tracks.. Generated automatically by the reactGenerator. */  var MusicAlbum= React.createClass({
...
ImageObject.'></div> );
      ...
      if( props.albumProductionType ){
        if( props.albumProductionType instanceof Array ){
          albumProductionType = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          albumProductionType = albumProductionType.concat( props.albumProductionType.map( function(result, index){
              return ( <MusicAlbumProductionType {...result} key={index} /> )
           }) );
         albumProductionType.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
      ...
      if( props.albumRelease ){
        if( props.albumRelease instanceof Array ){
          albumRelease = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          albumRelease = albumRelease.concat( props.albumRelease.map( function(result, index){
              return ( <MusicRelease {...result} key={index} /> )
           }) );
         albumRelease.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Organization.'></div> );
      ...
      if( props.albumReleaseType ){
        if( props.albumReleaseType instanceof Array ){
          albumReleaseType = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          albumReleaseType = albumReleaseType.concat( props.albumReleaseType.map( function(result, index){
              return ( <MusicAlbumReleaseType {...result} key={index} /> )
           }) );
         albumReleaseType.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
