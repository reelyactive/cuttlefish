/* Thing > CreativeWork > Review - A review of an item - for example, of a restaurant, movie, or store.. Generated automatically by the reactGenerator. */  var Review= React.createClass({
...
Organization.'></div> );
      ...
      if( props.reviewBody ){
        if( props.reviewBody instanceof Array ){
          reviewBody = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          reviewBody = reviewBody.concat( props.reviewBody.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. reviewBody is a Text.'></div> )
           }) );
         reviewBody.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            reviewBody = ( <div data-advice='Put your HTML here. reviewBody is a Text.'></div> );
        }
      }
      var citation;
      if( props.citation ){
...
Organization.'></div> );
      ...
      if( props.reviewRating ){
        if( props.reviewRating instanceof Array ){
          reviewRating = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          reviewRating = reviewRating.concat( props.reviewRating.map( function(result, index){
              return ( <Rating {...result} key={index} /> )
           }) );
         reviewRating.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          reviewRating = ( <Rating props={ props.reviewRating } /> );        }
      }
      var genre;
      if( props.genre ){
