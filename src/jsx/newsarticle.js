/* Thing > CreativeWork > Article > NewsArticle - A news article.. Generated automatically by the reactGenerator. */  var NewsArticle= React.createClass({
    ...
    render: function(){
      ...
      if( props.articleBody ){
        if( props.articleBody instanceof Array ){
          articleBody = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          articleBody = articleBody.concat( props.articleBody.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. articleBody is a Text.'></div> )
           }) );
         articleBody.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
CreativeWork.'></div> );
      ...
      if( props.pageEnd ){
        if( props.pageEnd instanceof Array ){
          pageEnd = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          pageEnd = pageEnd.concat( props.pageEnd.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. pageEnd is a Text or
Integer.'></div> )
           }) );
         pageEnd.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Organization.'></div> );
      ...
      if( props.articleSection ){
        if( props.articleSection instanceof Array ){
          articleSection = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          articleSection = articleSection.concat( props.articleSection.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. articleSection is a Text.'></div> )
           }) );
         articleSection.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Organization.'></div> );
      ...
      if( props.dateline ){
        if( props.dateline instanceof Array ){
          dateline = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          dateline = dateline.concat( props.dateline.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. dateline is a Text.'></div> )
           }) );
         dateline.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Organization.'></div> );
      ...
      if( props.pageStart ){
        if( props.pageStart instanceof Array ){
          pageStart = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          pageStart = pageStart.concat( props.pageStart.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. pageStart is a Text or
Integer.'></div> )
           }) );
         pageStart.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
CreativeWork.'></div> );
      ...
      if( props.printEdition ){
        if( props.printEdition instanceof Array ){
          printEdition = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          printEdition = printEdition.concat( props.printEdition.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. printEdition is a Text.'></div> )
           }) );
         printEdition.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Text.'></div> );
      ...
      if( props.printColumn ){
        if( props.printColumn instanceof Array ){
          printColumn = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          printColumn = printColumn.concat( props.printColumn.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. printColumn is a Text.'></div> )
           }) );
         printColumn.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
      ...
      if( props.pagination ){
        if( props.pagination instanceof Array ){
          pagination = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          pagination = pagination.concat( props.pagination.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. pagination is a Text.'></div> )
           }) );
         pagination.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
CreativeWork.'></div> );
      ...
      if( props.printSection ){
        if( props.printSection instanceof Array ){
          printSection = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          printSection = printSection.concat( props.printSection.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. printSection is a Text.'></div> )
           }) );
         printSection.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
      ...
      if( props.wordCount ){
        if( props.wordCount instanceof Array ){
          wordCount = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          wordCount = wordCount.concat( props.wordCount.map( function(result, index){
              return ( <Integer {...result} key={index} /> )
           }) );
         wordCount.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Text.'></div> );
      ...
      if( props.printPage ){
        if( props.printPage instanceof Array ){
          printPage = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          printPage = printPage.concat( props.printPage.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. printPage is a Text.'></div> )
           }) );
         printPage.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
