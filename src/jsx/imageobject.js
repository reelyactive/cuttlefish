/* Thing > CreativeWork > MediaObject > ImageObject - An image file.. Generated automatically by the reactGenerator. */  var ImageObject= React.createClass({
      ...
      if( props.exifData ){
        if( props.exifData instanceof Array ){
          ...
          exifData = exifData.concat( props.exifData.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. exifData is a PropertyValue or
Text.'></div> )
           }) );
         exifData.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            exifData = ( <div data-advice='Put your HTML here. exifData is a PropertyValue or
Text.'></div> );
        }
      }
      var expires;
