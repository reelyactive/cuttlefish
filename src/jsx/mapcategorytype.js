/* Thing > Intangible > Enumeration > MapCategoryType - An enumeration of several kinds of Map.. Generated automatically by the reactGenerator. */  var MapCategoryType= React.createClass({
...
CreativeWork.'></div> );
      ...
      return (<div title='MapCategoryType' className='MapCategoryType entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
