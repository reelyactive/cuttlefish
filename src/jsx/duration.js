/* Thing > Intangible > Quantity > Duration - Quantity: Duration (use ISO 8601 duration format).. Generated automatically by the reactGenerator. */  var Duration= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='Duration' className='Duration entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
