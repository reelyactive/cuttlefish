/* Thing > Intangible > Quantity > Distance - Properties that take Distances as values are of the form '<Number> <Length unit of measure>'. E.g., '7 ft'.. Generated automatically by the reactGenerator. */  var Distance= React.createClass({
...
CreativeWork.'></div> );
      ...
      return (<div title='Distance' className='Distance entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
