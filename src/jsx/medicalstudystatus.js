/* Thing > Intangible > Enumeration > MedicalEnumeration > MedicalStudyStatus - The status of a medical study. Enumerated type.. Generated automatically by the reactGenerator. */  var MedicalStudyStatus= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='MedicalStudyStatus' className='MedicalStudyStatus entity'>
        { code }
        { potentialAction }
        { description }
        { relevantSpecialty }
