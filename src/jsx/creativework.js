/* Thing > CreativeWork - The most generic kind of creative work, including books, movies, photographs, software programs, etc.. Generated automatically by the reactGenerator. */  var CreativeWork= React.createClass({
...
Text.'></div> );
      ...
      return (<div title='CreativeWork' className='CreativeWork entity'>
        { comment }
        { copyrightYear }
        { version }
        { producer }
