...
http://purl.org/goodrelations/v1#PublicHolidays. Generated automatically by the reactGenerator. */  var DayOfWeek= React.createClass({
...
URL.'></div> );
      ...
      return (<div title='DayOfWeek' className='DayOfWeek entity'>
        { potentialAction }
        { description }
        { sameAs }
        { image }
