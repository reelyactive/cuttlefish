    ...
    render: function(){
      ...
      if( this.props.representativeOfPage ){
        if( this.props.representativeOfPage instanceof Array ){
          representativeOfPage = [(<p>representativeOfPage:</p> )];
      ...
      if( this.props.exifData ){
        if( this.props.exifData instanceof Array ){
          exifData = [(<p>exifData:</p> )];
          for( i in this.props.exifData ){
            exifData.push( ( <div class='exifData'></div> ) );
          }
        } else {
          exifData = ( <div class='exifData'>{this.props.exifData}</div> );
        }
      }
      var expires;
