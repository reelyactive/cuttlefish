      ...
      if( props.producer ){
        if( props.producer instanceof Array ){
          ...
          producer = producer.concat( props.producer.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. producer is a Organization or
Person.'></div> )
           }) );
      ...
      if( props.creator ){
        if( props.creator instanceof Array ){
          ...
          creator = creator.concat( props.creator.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. creator is a Organization or
Person.'></div> )
           }) );
      ...
      if( props.provider ){
        if( props.provider instanceof Array ){
          ...
          provider = provider.concat( props.provider.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. provider is a Organization or
Person.'></div> )
           }) );
      ...
      if( props.contributor ){
        if( props.contributor instanceof Array ){
          ...
          contributor = contributor.concat( props.contributor.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. contributor is a Organization or
Person.'></div> )
           }) );
...
Person.'></div> );
      ...
      if( props.representativeOfPage ){
        if( props.representativeOfPage instanceof Array ){
          representativeOfPage = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          representativeOfPage = representativeOfPage.concat( props.representativeOfPage.map( function(result, index){
              return ( <Boolean {...result} key={index} /> )
           }) );
         representativeOfPage.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          representativeOfPage = ( <Boolean props={ props.representativeOfPage } /> );        }
      }
      var width;
      if( props.width ){
      ...
      if( props.copyrightHolder ){
        if( props.copyrightHolder instanceof Array ){
          ...
          copyrightHolder = copyrightHolder.concat( props.copyrightHolder.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. copyrightHolder is a Organization or
Person.'></div> )
           }) );
      ...
      if( props.inLanguage ){
        if( props.inLanguage instanceof Array ){
          ...
          inLanguage = inLanguage.concat( props.inLanguage.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. inLanguage is a Text or
Language.'></div> )
           }) );
      ...
      if( props.author ){
        if( props.author instanceof Array ){
          ...
          author = author.concat( props.author.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. author is a Organization or
Person.'></div> )
           }) );
...
Person.'></div> );
      ...
      if( props.exifData ){
        if( props.exifData instanceof Array ){
          exifData = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          exifData = exifData.concat( props.exifData.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. exifData is a Text or
PropertyValue.'></div> )
           }) );
         exifData.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
            exifData = ( <div data-advice='Put your HTML here. exifData is a Text or
PropertyValue.'></div> );
        }
      }
      var expires;
      ...
      if( props.translator ){
        if( props.translator instanceof Array ){
          ...
          translator = translator.concat( props.translator.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. translator is a Organization or
Person.'></div> )
           }) );
      ...
      if( props.schemaVersion ){
        if( props.schemaVersion instanceof Array ){
          ...
          schemaVersion = schemaVersion.concat( props.schemaVersion.map( function(result, index){
              return ( <div key={index} data-advice='Put your HTML here. schemaVersion is a Text or
URL.'></div> )
           }) );
