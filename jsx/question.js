...
Organization.'></div> );
      ...
      if( props.answerCount ){
        if( props.answerCount instanceof Array ){
          answerCount = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          answerCount = answerCount.concat( props.answerCount.map( function(result, index){
              return ( <Integer {...result} key={index} /> )
           }) );
         answerCount.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          answerCount = ( <Integer props={ props.answerCount } /> );        }
      }
      var hasPart;
      if( props.hasPart ){
      ...
      if( props.acceptedAnswer ){
        if( props.acceptedAnswer instanceof Array ){
          acceptedAnswer = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          acceptedAnswer = acceptedAnswer.concat( props.acceptedAnswer.map( function(result, index){
              return ( <Answer {...result} key={index} /> )
           }) );
         acceptedAnswer.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          acceptedAnswer = ( <Answer props={ props.acceptedAnswer } /> );        }
      }
      var downvoteCount;
      if( props.downvoteCount ){
        if( props.downvoteCount instanceof Array ){
          downvoteCount = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          downvoteCount = downvoteCount.concat( props.downvoteCount.map( function(result, index){
              return ( <Integer {...result} key={index} /> )
           }) );
         downvoteCount.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
...
Text.'></div> );
      ...
      if( props.suggestedAnswer ){
        if( props.suggestedAnswer instanceof Array ){
          suggestedAnswer = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          suggestedAnswer = suggestedAnswer.concat( props.suggestedAnswer.map( function(result, index){
              return ( <Answer {...result} key={index} /> )
           }) );
         suggestedAnswer.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          suggestedAnswer = ( <Answer props={ props.suggestedAnswer } /> );        }
      }
      ...
      if( props.upvoteCount ){
        if( props.upvoteCount instanceof Array ){
          upvoteCount = [ (<div key='header' data-advice='HTML for the *head* of the section'></div>) ]
          upvoteCount = upvoteCount.concat( props.upvoteCount.map( function(result, index){
              return ( <Integer {...result} key={index} /> )
           }) );
         upvoteCount.push( ( <div key='footer' data-advice='HTML for the *footer* of the section'></div> ) );
        } else {
          upvoteCount = ( <Integer props={ props.upvoteCount } /> );        }
      }
      return (<div title='Question' className='Question entity'>
        { comment }
        { copyrightYear }
        { version }
        { producer }
