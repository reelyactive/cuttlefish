...
Person.'></div> ) );
      ...
      if( this.props.answerCount ){
        if( this.props.answerCount instanceof Array ){
          answerCount = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in this.props.answerCount ){
            answerCount.push( ( <Integer props={ this.props.answerCount } /> ) );          }
        } else {
          answerCount = ( <Integer props={ this.props.answerCount } /> );        }
      }
      var hasPart;
      ...
      if( this.props.acceptedAnswer ){
        if( this.props.acceptedAnswer instanceof Array ){
          acceptedAnswer = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in this.props.acceptedAnswer ){
            acceptedAnswer.push( ( <Answer props={ this.props.acceptedAnswer } /> ) );          }
        } else {
          acceptedAnswer = ( <Answer props={ this.props.acceptedAnswer } /> );        }
      }
      var downvoteCount;
      if( this.props.downvoteCount ){
        if( this.props.downvoteCount instanceof Array ){
          ...
          for( i in this.props.downvoteCount ){
            downvoteCount.push( ( <Integer props={ this.props.downvoteCount } /> ) );          }
        } else {
          downvoteCount = ( <Integer props={ this.props.downvoteCount } /> );        }
      }
      var recordedAt;
...
Language.'></div> ) );
      ...
      if( this.props.suggestedAnswer ){
        if( this.props.suggestedAnswer instanceof Array ){
          suggestedAnswer = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in this.props.suggestedAnswer ){
            suggestedAnswer.push( ( <Answer props={ this.props.suggestedAnswer } /> ) );          }
        } else {
          suggestedAnswer = ( <Answer props={ this.props.suggestedAnswer } /> );        }
      }
      ...
      if( this.props.upvoteCount ){
        if( this.props.upvoteCount instanceof Array ){
          ...
          for( i in this.props.upvoteCount ){
            upvoteCount.push( ( <Integer props={ this.props.upvoteCount } /> ) );          }
        } else {
          upvoteCount = ( <Integer props={ this.props.upvoteCount } /> );        }
      }
