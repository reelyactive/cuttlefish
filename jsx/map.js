...
URL.'></div> ) );
      ...
      if( this.props.mapType ){
        if( this.props.mapType instanceof Array ){
          mapType = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in this.props.mapType ){
            mapType.push( ( <MapCategoryType props={ this.props.mapType } /> ) );          }
        } else {
          mapType = ( <MapCategoryType props={ this.props.mapType } /> );        }
      }
      var provider;
