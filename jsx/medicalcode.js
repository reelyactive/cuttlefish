    ...
    render: function(){
      ...
      if( this.props.codeValue ){
        if( this.props.codeValue instanceof Array ){
          codeValue = [(<p>codeValue:</p> )];
          for( i in this.props.codeValue ){
            codeValue.push( ( <div class='codeValue'></div> ) );
          }
        } else {
          codeValue = ( <div class='codeValue'>{this.props.codeValue}</div> );
        }
      }
      ...
      if( this.props.codingSystem ){
        if( this.props.codingSystem instanceof Array ){
          codingSystem = [(<p>codingSystem:</p> )];
          for( i in this.props.codingSystem ){
            codingSystem.push( ( <div class='codingSystem'></div> ) );
          }
        } else {
          codingSystem = ( <div class='codingSystem'>{this.props.codingSystem}</div> );
        }
      }
      var alternateName;
