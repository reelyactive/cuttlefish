    ...
    render: function(){
      ...
      if( this.props.reviewBody ){
        if( this.props.reviewBody instanceof Array ){
          reviewBody = [(<p>reviewBody:</p> )];
          for( i in this.props.reviewBody ){
            reviewBody.push( ( <div class='reviewBody'></div> ) );
          }
        } else {
          reviewBody = ( <div class='reviewBody'>{this.props.reviewBody}</div> );
        }
      }
      var citation;
