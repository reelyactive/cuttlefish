    ...
    render: function(){
      ...
      if( this.props.geographicArea ){
        if( this.props.geographicArea instanceof Array ){
          geographicArea = [(<p>geographicArea:</p> )];
          for( i in this.props.geographicArea ){
            geographicArea.push( ( <AdministrativeArea props={ this.props.geographicArea } /> ) );          }
        } else {
      ...
      if( this.props.audienceType ){
        if( this.props.audienceType instanceof Array ){
          audienceType = [(<p>audienceType:</p> )];
          for( i in this.props.audienceType ){
            audienceType.push( ( <div class='audienceType'></div> ) );
          }
        } else {
          audienceType = ( <div class='audienceType'>{this.props.audienceType}</div> );
        }
      }
