    ...
    render: function(){
      ...
      if( props.warrantyScope ){
        if( props.warrantyScope instanceof Array ){
          warrantyScope = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in props.warrantyScope ){
            warrantyScope.push( ( <WarrantyScope {...props.warrantyScope } /> ) );          }
        } else {
...
ImageObject.'></div> );
      ...
      if( props.durationOfWarranty ){
        if( props.durationOfWarranty instanceof Array ){
          durationOfWarranty = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in props.durationOfWarranty ){
            durationOfWarranty.push( ( <QuantitativeValue {...props.durationOfWarranty } /> ) );          }
        } else {
