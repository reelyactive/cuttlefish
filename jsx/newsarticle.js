    ...
    render: function(){
      ...
      if( this.props.articleBody ){
        if( this.props.articleBody instanceof Array ){
          ...
          for( i in this.props.articleBody ){
            articleBody.push( ( <div class='articleBody'></div> ) );
          }
        } else {
          articleBody = ( <div class='articleBody'>{this.props.articleBody}</div> );
        }
      }
      var version;
      ...
      if( this.props.pageEnd ){
        if( this.props.pageEnd instanceof Array ){
          ...
          for( i in this.props.pageEnd ){
            pageEnd.push( ( <div class='pageEnd'></div> ) );
          }
        } else {
          pageEnd = ( <div class='pageEnd'>{this.props.pageEnd}</div> );
        }
      }
      var commentCount;
      ...
      if( this.props.articleSection ){
        if( this.props.articleSection instanceof Array ){
          articleSection = [(<p>articleSection:</p> )];
          for( i in this.props.articleSection ){
            articleSection.push( ( <div class='articleSection'></div> ) );
          }
        } else {
          articleSection = ( <div class='articleSection'>{this.props.articleSection}</div> );
        }
      }
      var thumbnailUrl;
      ...
      if( this.props.dateline ){
        if( this.props.dateline instanceof Array ){
          ...
          for( i in this.props.dateline ){
            dateline.push( ( <div class='dateline'></div> ) );
          }
        } else {
          dateline = ( <div class='dateline'>{this.props.dateline}</div> );
        }
      }
      var creator;
      ...
      if( this.props.pageStart ){
        if( this.props.pageStart instanceof Array ){
          pageStart = [(<p>pageStart:</p> )];
          for( i in this.props.pageStart ){
            pageStart.push( ( <div class='pageStart'></div> ) );
          }
        } else {
          pageStart = ( <div class='pageStart'>{this.props.pageStart}</div> );
        }
      }
      ...
      if( this.props.printEdition ){
        if( this.props.printEdition instanceof Array ){
          printEdition = [(<p>printEdition:</p> )];
          for( i in this.props.printEdition ){
            printEdition.push( ( <div class='printEdition'></div> ) );
          }
        } else {
          printEdition = ( <div class='printEdition'>{this.props.printEdition}</div> );
        }
      }
      var about;
      if( this.props.about ){
      ...
      if( this.props.printColumn ){
        if( this.props.printColumn instanceof Array ){
          printColumn = [(<p>printColumn:</p> )];
          for( i in this.props.printColumn ){
            printColumn.push( ( <div class='printColumn'></div> ) );
          }
        } else {
          printColumn = ( <div class='printColumn'>{this.props.printColumn}</div> );
        }
      }
      var contentLocation;
      ...
      if( this.props.pagination ){
        if( this.props.pagination instanceof Array ){
          ...
          for( i in this.props.pagination ){
            pagination.push( ( <div class='pagination'></div> ) );
          }
        } else {
          pagination = ( <div class='pagination'>{this.props.pagination}</div> );
        }
      }
      var potentialAction;
      ...
      if( this.props.printSection ){
        if( this.props.printSection instanceof Array ){
          printSection = [(<p>printSection:</p> )];
          for( i in this.props.printSection ){
            printSection.push( ( <div class='printSection'></div> ) );
          }
        } else {
          printSection = ( <div class='printSection'>{this.props.printSection}</div> );
        }
      }
      var wordCount;
      ...
      if( this.props.printPage ){
        if( this.props.printPage instanceof Array ){
          printPage = [(<p>printPage:</p> )];
          for( i in this.props.printPage ){
            printPage.push( ( <div class='printPage'></div> ) );
          }
        } else {
          printPage = ( <div class='printPage'>{this.props.printPage}</div> );
        }
      }
