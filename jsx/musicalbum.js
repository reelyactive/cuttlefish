    ...
    render: function(){
      ...
      if( this.props.albumProductionType ){
        if( this.props.albumProductionType instanceof Array ){
          albumProductionType = [(<p>albumProductionType:</p> )];
          for( i in this.props.albumProductionType ){
            albumProductionType.push( ( <MusicAlbumProductionType props={ this.props.albumProductionType } /> ) );          }
        } else {
          albumProductionType = ( <MusicAlbumProductionType props={ this.props.albumProductionType } /> );        }
      }
      var sameAs;
      ...
      if( this.props.albumRelease ){
        if( this.props.albumRelease instanceof Array ){
          albumRelease = [(<p>albumRelease:</p> )];
          for( i in this.props.albumRelease ){
            albumRelease.push( ( <MusicRelease props={ this.props.albumRelease } /> ) );          }
        } else {
          albumRelease = ( <MusicRelease props={ this.props.albumRelease } /> );        }
      }
      var associatedMedia;
      ...
      if( this.props.albumReleaseType ){
        if( this.props.albumReleaseType instanceof Array ){
          albumReleaseType = [(<p>albumReleaseType:</p> )];
          for( i in this.props.albumReleaseType ){
            albumReleaseType.push( ( <MusicAlbumReleaseType props={ this.props.albumReleaseType } /> ) );          }
        } else {
          albumReleaseType = ( <MusicAlbumReleaseType props={ this.props.albumReleaseType } /> );        }
      }
      var publication;
