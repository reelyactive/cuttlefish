    ...
    render: function(){
      ...
      if( this.props.isrcCode ){
        if( this.props.isrcCode instanceof Array ){
          isrcCode = [(<p>isrcCode:</p> )];
          for( i in this.props.isrcCode ){
            isrcCode.push( ( <div class='isrcCode'></div> ) );
          }
        } else {
          isrcCode = ( <div class='isrcCode'>{this.props.isrcCode}</div> );
        }
      }
      var educationalUse;
