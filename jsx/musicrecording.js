...
Organization.'></div> );
      ...
      if( props.inPlaylist ){
        if( props.inPlaylist instanceof Array ){
          ...
          for( i in props.inPlaylist ){
            inPlaylist.push( ( <MusicPlaylist {...props.inPlaylist } /> ) );          }
        } else {
...
CreativeWork.'></div> );
      ...
      if( props.recordingOf ){
        if( props.recordingOf instanceof Array ){
          ...
          for( i in props.recordingOf ){
            recordingOf.push( ( <MusicComposition {...props.recordingOf } /> ) );          }
        } else {
...
Organization.'></div> );
      ...
      if( props.inAlbum ){
        if( props.inAlbum instanceof Array ){
          ...
          for( i in props.inAlbum ){
            inAlbum.push( ( <MusicAlbum {...props.inAlbum } /> ) );          }
        } else {
