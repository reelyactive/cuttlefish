    ...
    render: function(){
      ...
      if( props.recordLabel ){
        if( props.recordLabel instanceof Array ){
          recordLabel = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in props.recordLabel ){
            recordLabel.push( ( <Organization {...props.recordLabel } /> ) );          }
        } else {
...
CreativeWork.'></div> );
      ...
      if( props.catalogNumber ){
        if( props.catalogNumber instanceof Array ){
          catalogNumber = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in props.catalogNumber ){
            catalogNumber.push( ( <div data-advice='Put your HTML here. catalogNumber is a Text.'></div> ) );
          }
        } else {
      ...
      if( props.releaseOf ){
        if( props.releaseOf instanceof Array ){
          releaseOf = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in props.releaseOf ){
            releaseOf.push( ( <MusicAlbum {...props.releaseOf } /> ) );          }
        } else {
...
Organization.'></div> );
      ...
      if( props.creditedTo ){
        if( props.creditedTo instanceof Array ){
          creditedTo = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in props.creditedTo ){
            creditedTo.push( ( <div data-advice='Put your HTML here. creditedTo is a Person or
Organization.'></div> ) );
          }
        } else {
...
Text.'></div> );
      ...
      if( props.musicReleaseFormat ){
        if( props.musicReleaseFormat instanceof Array ){
          musicReleaseFormat = [( <div data-advice='HTML for the *head* of the section'></div> )];
          for( i in props.musicReleaseFormat ){
            musicReleaseFormat.push( ( <MusicReleaseFormatType {...props.musicReleaseFormat } /> ) );          }
        } else {
