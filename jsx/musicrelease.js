      ...
      if( this.props.recordLabel ){
        if( this.props.recordLabel instanceof Array ){
          ...
          for( i in this.props.recordLabel ){
            recordLabel.push( ( <Organization {...this.props.recordLabel } /> ) );          }
        } else {
          recordLabel = ( <Organization props={ this.props.recordLabel } /> );        }
      }
      var version;
      ...
      if( this.props.releaseOf ){
        if( this.props.releaseOf instanceof Array ){
          ...
          for( i in this.props.releaseOf ){
            releaseOf.push( ( <MusicAlbum {...this.props.releaseOf } /> ) );          }
        } else {
          releaseOf = ( <MusicAlbum props={ this.props.releaseOf } /> );        }
      }
      ...
      if( this.props.musicReleaseFormat ){
        if( this.props.musicReleaseFormat instanceof Array ){
          ...
          for( i in this.props.musicReleaseFormat ){
            musicReleaseFormat.push( ( <MusicReleaseFormatType {...this.props.musicReleaseFormat } /> ) );          }
        } else {
          musicReleaseFormat = ( <MusicReleaseFormatType props={ this.props.musicReleaseFormat } /> );        }
      }
      var name;
      if( this.props.name ){
      ...
      if( this.props.numTracks ){
        if( this.props.numTracks instanceof Array ){
          ...
          for( i in this.props.numTracks ){
            numTracks.push( ( <Integer {...this.props.numTracks } /> ) );          }
        } else {
          numTracks = ( <Integer props={ this.props.numTracks } /> );        }
      }
      var inLanguage;
