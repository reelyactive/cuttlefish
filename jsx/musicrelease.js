    ...
    render: function(){
      ...
      if( this.props.catalogNumber ){
        if( this.props.catalogNumber instanceof Array ){
          catalogNumber = [(<p>catalogNumber:</p> )];
          for( i in this.props.catalogNumber ){
            catalogNumber.push( ( <div class='catalogNumber'></div> ) );
          }
        } else {
          catalogNumber = ( <div class='catalogNumber'>{this.props.catalogNumber}</div> );
        }
      }
      var isPartOf;
      ...
      if( this.props.creditedTo ){
        if( this.props.creditedTo instanceof Array ){
          creditedTo = [(<p>creditedTo:</p> )];
          for( i in this.props.creditedTo ){
            creditedTo.push( ( <div class='creditedTo'></div> ) );
          }
        } else {
          creditedTo = ( <div class='creditedTo'>{this.props.creditedTo}</div> );
        }
      }
      var award;
      if( this.props.award ){
      ...
      if( this.props.musicReleaseFormat ){
        if( this.props.musicReleaseFormat instanceof Array ){
          musicReleaseFormat = [(<p>musicReleaseFormat:</p> )];
