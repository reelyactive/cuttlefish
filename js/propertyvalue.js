    ...
    render: function(){
      ...
      if( this.props.propertyID ){
        if( this.props.propertyID instanceof Array ){
          propertyID = [(React.createElement("p", null, "propertyID:") )];
          for( i in this.props.propertyID ){
            propertyID.push( ( React.createElement("div", {class: "propertyID"}) ) );
          }
        } else {
          propertyID = ( React.createElement("div", {class: "propertyID"}, this.props.propertyID) );
        }
      }
      var name;
      if( this.props.name ){
