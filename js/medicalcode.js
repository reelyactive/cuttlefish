    ...
    render: function(){
      ...
      if( this.props.codeValue ){
        if( this.props.codeValue instanceof Array ){
          codeValue = [(React.createElement("p", null, "codeValue:") )];
          for( i in this.props.codeValue ){
            codeValue.push( ( React.createElement("div", {class: "codeValue"}) ) );
          }
        } else {
          codeValue = ( React.createElement("div", {class: "codeValue"}, this.props.codeValue) );
        }
      }
      ...
      if( this.props.codingSystem ){
        if( this.props.codingSystem instanceof Array ){
          codingSystem = [(React.createElement("p", null, "codingSystem:") )];
          for( i in this.props.codingSystem ){
            codingSystem.push( ( React.createElement("div", {class: "codingSystem"}) ) );
          }
        } else {
          codingSystem = ( React.createElement("div", {class: "codingSystem"}, this.props.codingSystem) );
        }
      }
      var alternateName;
