    ...
    render: function(){
      ...
      if( this.props.inverseOf ){
        if( this.props.inverseOf instanceof Array ){
          inverseOf = [(React.createElement("p", null, "inverseOf:") )];
          for( i in this.props.inverseOf ){
            inverseOf.push( ( React.createElement(Property, {props:  this.props.inverseOf}) ) );          }
        } else {
          inverseOf = ( React.createElement(Property, {props:  this.props.inverseOf}) );        }
      }
      var sameAs;
      ...
      if( this.props.rangeIncludes ){
        if( this.props.rangeIncludes instanceof Array ){
          rangeIncludes = [(React.createElement("p", null, "rangeIncludes:") )];
          for( i in this.props.rangeIncludes ){
            rangeIncludes.push( ( React.createElement(Class, {props:  this.props.rangeIncludes}) ) );          }
        } else {
          rangeIncludes = ( React.createElement(Class, {props:  this.props.rangeIncludes}) );        }
      }
      var image;
      if( this.props.image ){
      ...
      if( this.props.domainIncludes ){
        if( this.props.domainIncludes instanceof Array ){
          domainIncludes = [(React.createElement("p", null, "domainIncludes:") )];
          for( i in this.props.domainIncludes ){
            domainIncludes.push( ( React.createElement(Class, {props:  this.props.domainIncludes}) ) );          }
        } else {
          domainIncludes = ( React.createElement(Class, {props:  this.props.domainIncludes}) );        }
      }
      var name;
      if( this.props.name ){
