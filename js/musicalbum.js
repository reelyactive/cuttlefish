      ...
      if( props.albumProductionType ){
        if( props.albumProductionType instanceof Array ){
          ...
          for( i in props.albumProductionType ){
            albumProductionType.push( ( React.createElement(MusicAlbumProductionType, React.__spread({},  props.albumProductionType )) ) );          }
        } else {
      ...
      if( props.albumRelease ){
        if( props.albumRelease instanceof Array ){
          ...
          for( i in props.albumRelease ){
            albumRelease.push( ( React.createElement(MusicRelease, React.__spread({},  props.albumRelease )) ) );          }
        } else {
      ...
      if( props.albumReleaseType ){
        if( props.albumReleaseType instanceof Array ){
          ...
          for( i in props.albumReleaseType ){
            albumReleaseType.push( ( React.createElement(MusicAlbumReleaseType, React.__spread({},  props.albumReleaseType )) ) );          }
        } else {
