...
"Organization."}) );
      ...
      if( props.representativeOfPage ){
        if( props.representativeOfPage instanceof Array ){
          ...
          for( i in props.representativeOfPage ){
            representativeOfPage.push( ( React.createElement(Boolean, React.__spread({},  props.representativeOfPage )) ) );          }
        } else {
