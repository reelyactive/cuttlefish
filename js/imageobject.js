...
"Organization."}) );
      ...
      if( this.props.representativeOfPage ){
        if( this.props.representativeOfPage instanceof Array ){
          representativeOfPage = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.representativeOfPage ){
            representativeOfPage.push( ( React.createElement(Boolean, React.__spread({},  this.props.representativeOfPage )) ) );          }
        } else {
...
"Organization."}) );
      ...
      if( this.props.exifData ){
        if( this.props.exifData instanceof Array ){
          exifData = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.exifData ){
            exifData.push( ( React.createElement("div", {"data-advice": "Put your HTML here. exifData is a PropertyValue or" + ' ' +
"Text."}) ) );
          }
        } else {
