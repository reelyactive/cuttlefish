...
"ImageObject."}) );
      ...
      if( props.geographicArea ){
        if( props.geographicArea instanceof Array ){
          geographicArea = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in props.geographicArea ){
            geographicArea.push( ( React.createElement(AdministrativeArea, React.__spread({},  props.geographicArea )) ) );          }
        } else {
      ...
      if( props.audienceType ){
        if( props.audienceType instanceof Array ){
          audienceType = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in props.audienceType ){
            audienceType.push( ( React.createElement("div", {"data-advice": "Put your HTML here. audienceType is a Text."}) ) );
          }
        } else {
