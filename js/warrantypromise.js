    ...
    render: function(){
      ...
      if( this.props.warrantyScope ){
        if( this.props.warrantyScope instanceof Array ){
          warrantyScope = [(React.createElement("p", null, "warrantyScope:") )];
          for( i in this.props.warrantyScope ){
            warrantyScope.push( ( React.createElement(WarrantyScope, {props:  this.props.warrantyScope}) ) );          }
        } else {
      ...
      if( this.props.durationOfWarranty ){
        if( this.props.durationOfWarranty instanceof Array ){
          durationOfWarranty = [(React.createElement("p", null, "durationOfWarranty:") )];
          for( i in this.props.durationOfWarranty ){
            durationOfWarranty.push( ( React.createElement(QuantitativeValue, {props:  this.props.durationOfWarranty}) ) );          }
        } else {
