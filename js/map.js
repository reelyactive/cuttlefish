...
"CreativeWork."}) );
      ...
      if( this.props.mapType ){
        if( this.props.mapType instanceof Array ){
          mapType = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.mapType ){
            mapType.push( ( React.createElement(MapCategoryType, React.__spread({},  this.props.mapType )) ) );          }
        } else {
          mapType = ( React.createElement(MapCategoryType, {props:  this.props.mapType}) );        }
      }
      var provider;
