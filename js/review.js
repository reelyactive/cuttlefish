      ...
      if( props.itemReviewed ){
        if( props.itemReviewed instanceof Array ){
          ...
          for( i in props.itemReviewed ){
            itemReviewed.push( ( React.createElement(Thing, React.__spread({},  props.itemReviewed )) ) );          }
        } else {
...
"Organization."}) );
      ...
      if( props.reviewRating ){
        if( props.reviewRating instanceof Array ){
          ...
          for( i in props.reviewRating ){
            reviewRating.push( ( React.createElement(Rating, React.__spread({},  props.reviewRating )) ) );          }
        } else {
