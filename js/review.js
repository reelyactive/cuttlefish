    ...
    render: function(){
      ...
      if( this.props.reviewBody ){
        if( this.props.reviewBody instanceof Array ){
          reviewBody = [(React.createElement("p", null, "reviewBody:") )];
          for( i in this.props.reviewBody ){
            reviewBody.push( ( React.createElement("div", {class: "reviewBody"}) ) );
          }
        } else {
          reviewBody = ( React.createElement("div", {class: "reviewBody"}, this.props.reviewBody) );
        }
      }
      var citation;
      ...
      if( this.props.reviewRating ){
        if( this.props.reviewRating instanceof Array ){
          reviewRating = [(React.createElement("p", null, "reviewRating:") )];
