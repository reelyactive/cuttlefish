/* Thing > CreativeWork > Comment > Answer - An answer offered to a question; perhaps correct, perhaps opinionated or wrong.. Generated automatically by the reactGenerator. */
...
"Organization."}) );
      ...
      if( this.props.parentItem ){
        if( this.props.parentItem instanceof Array ){
          parentItem = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.parentItem ){
            parentItem.push( ( React.createElement(Question, React.__spread({},  this.props.parentItem )) ) );          }
        } else {
          parentItem = ( React.createElement(Question, {props:  this.props.parentItem}) );        }
      }
