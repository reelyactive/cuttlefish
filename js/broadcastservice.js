      ...
      if( props.broadcastAffiliateOf ){
        if( props.broadcastAffiliateOf instanceof Array ){
          ...
          for( i in props.broadcastAffiliateOf ){
            broadcastAffiliateOf.push( ( React.createElement(Organization, React.__spread({},  props.broadcastAffiliateOf )) ) );          }
        } else {
      ...
      if( props.parentService ){
        if( props.parentService instanceof Array ){
          ...
          for( i in props.parentService ){
            parentService.push( ( React.createElement(BroadcastService, React.__spread({},  props.parentService )) ) );          }
        } else {
      ...
      if( props.broadcaster ){
        if( props.broadcaster instanceof Array ){
          ...
          for( i in props.broadcaster ){
            broadcaster.push( ( React.createElement(Organization, React.__spread({},  props.broadcaster )) ) );          }
        } else {
