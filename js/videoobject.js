...
"Organization."}) );
      ...
      if( props.musicBy ){
        if( props.musicBy instanceof Array ){
          ...
          for( i in props.musicBy ){
            musicBy.push( ( React.createElement("div", {"data-advice": "Put your HTML here. musicBy is a Person or" + ' ' +
"MusicGroup."}) ) );
          }
        } else {
            musicBy = ( React.createElement("div", {"data-advice": "Put your HTML here. musicBy is a Person or" + ' ' +
"MusicGroup."}) );
        }
      }
      var commentCount;
...
"Organization."}) );
      ...
      if( props.thumbnail ){
        if( props.thumbnail instanceof Array ){
          ...
          for( i in props.thumbnail ){
            thumbnail.push( ( React.createElement(ImageObject, React.__spread({},  props.thumbnail )) ) );          }
        } else {
      ...
      if( props.director ){
        if( props.director instanceof Array ){
          ...
          for( i in props.director ){
            director.push( ( React.createElement(Person, React.__spread({},  props.director )) ) );          }
        } else {
...
"Organization."}) );
      ...
      if( props.actor ){
        if( props.actor instanceof Array ){
          ...
          for( i in props.actor ){
            actor.push( ( React.createElement(Person, React.__spread({},  props.actor )) ) );          }
        } else {
