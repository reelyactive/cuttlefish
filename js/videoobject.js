...
"Organization."}) );
      ...
      if( this.props.associatedArticle ){
        if( this.props.associatedArticle instanceof Array ){
          ...
          for( i in this.props.associatedArticle ){
            associatedArticle.push( ( React.createElement(NewsArticle, React.__spread({},  this.props.associatedArticle )) ) );          }
        } else {
      ...
      if( this.props.videoQuality ){
        if( this.props.videoQuality instanceof Array ){
          videoQuality = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.videoQuality ){
            videoQuality.push( ( React.createElement("div", {"data-advice": "Put your HTML here. videoQuality is a Text."}) ) );
          }
        } else {
      ...
      if( this.props.encodesCreativeWork ){
        if( this.props.encodesCreativeWork instanceof Array ){
          ...
          for( i in this.props.encodesCreativeWork ){
            encodesCreativeWork.push( ( React.createElement(CreativeWork, React.__spread({},  this.props.encodesCreativeWork )) ) );          }
        } else {
...
"Organization."}) );
      ...
      if( this.props.musicBy ){
        if( this.props.musicBy instanceof Array ){
          musicBy = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.musicBy ){
            musicBy.push( ( React.createElement("div", {"data-advice": "Put your HTML here. musicBy is a MusicGroup or" + ' ' +
"Person."}) ) );
          }
        } else {
      ...
      if( this.props.productionCompany ){
        if( this.props.productionCompany instanceof Array ){
          ...
          for( i in this.props.productionCompany ){
            productionCompany.push( ( React.createElement(Organization, React.__spread({},  this.props.productionCompany )) ) );          }
        } else {
...
"Organization."}) );
      ...
      if( this.props.thumbnail ){
        if( this.props.thumbnail instanceof Array ){
          thumbnail = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.thumbnail ){
            thumbnail.push( ( React.createElement(ImageObject, React.__spread({},  this.props.thumbnail )) ) );          }
        } else {
      ...
      if( this.props.director ){
        if( this.props.director instanceof Array ){
          director = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.director ){
            director.push( ( React.createElement(Person, React.__spread({},  this.props.director )) ) );          }
        } else {
          director = ( React.createElement(Person, {props:  this.props.director}) );        }
      }
      var about;
      if( this.props.about ){
...
"CreativeWork."}) );
      ...
      if( this.props.caption ){
        if( this.props.caption instanceof Array ){
          caption = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.caption ){
            caption.push( ( React.createElement("div", {"data-advice": "Put your HTML here. caption is a Text."}) ) );
          }
        } else {
      ...
      if( this.props.requiresSubscription ){
        if( this.props.requiresSubscription instanceof Array ){
          ...
          for( i in this.props.requiresSubscription ){
            requiresSubscription.push( ( React.createElement(Boolean, React.__spread({},  this.props.requiresSubscription )) ) );          }
        } else {
...
"Organization."}) );
      ...
      if( this.props.videoFrameSize ){
        if( this.props.videoFrameSize instanceof Array ){
          videoFrameSize = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.videoFrameSize ){
            videoFrameSize.push( ( React.createElement("div", {"data-advice": "Put your HTML here. videoFrameSize is a Text."}) ) );
          }
        } else {
      ...
      if( this.props.regionsAllowed ){
        if( this.props.regionsAllowed instanceof Array ){
          ...
          for( i in this.props.regionsAllowed ){
            regionsAllowed.push( ( React.createElement(Place, React.__spread({},  this.props.regionsAllowed )) ) );          }
        } else {
...
"Organization."}) );
      ...
      if( this.props.actor ){
        if( this.props.actor instanceof Array ){
          actor = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.actor ){
            actor.push( ( React.createElement(Person, React.__spread({},  this.props.actor )) ) );          }
        } else {
          actor = ( React.createElement(Person, {props:  this.props.actor}) );        }
      }
      var dateModified;
...
"Text."}) );
      ...
      if( this.props.transcript ){
        if( this.props.transcript instanceof Array ){
          transcript = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.transcript ){
            transcript.push( ( React.createElement("div", {"data-advice": "Put your HTML here. transcript is a Text."}) ) );
          }
        } else {
