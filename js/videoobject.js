    ...
    render: function(){
      ...
      if( this.props.videoQuality ){
        if( this.props.videoQuality instanceof Array ){
          videoQuality = [(React.createElement("p", null, "videoQuality:") )];
          for( i in this.props.videoQuality ){
            videoQuality.push( ( React.createElement("div", {class: "videoQuality"}) ) );
          }
        } else {
          videoQuality = ( React.createElement("div", {class: "videoQuality"}, this.props.videoQuality) );
        }
      }
      ...
      if( this.props.musicBy ){
        if( this.props.musicBy instanceof Array ){
          musicBy = [(React.createElement("p", null, "musicBy:") )];
          for( i in this.props.musicBy ){
            musicBy.push( ( React.createElement("div", {class: "musicBy"}) ) );
          }
        } else {
          musicBy = ( React.createElement("div", {class: "musicBy"}, this.props.musicBy) );
        }
      }
      var commentCount;
      ...
      if( this.props.director ){
        if( this.props.director instanceof Array ){
          director = [(React.createElement("p", null, "director:") )];
          for( i in this.props.director ){
            director.push( ( React.createElement(Person, {props:  this.props.director}) ) );          }
        } else {
      ...
      if( this.props.videoFrameSize ){
        if( this.props.videoFrameSize instanceof Array ){
          videoFrameSize = [(React.createElement("p", null, "videoFrameSize:") )];
          for( i in this.props.videoFrameSize ){
            videoFrameSize.push( ( React.createElement("div", {class: "videoFrameSize"}) ) );
          }
        } else {
          videoFrameSize = ( React.createElement("div", {class: "videoFrameSize"}, this.props.videoFrameSize) );
        }
      }
      var regionsAllowed;
      ...
      if( this.props.actor ){
        if( this.props.actor instanceof Array ){
          actor = [(React.createElement("p", null, "actor:") )];
          for( i in this.props.actor ){
            actor.push( ( React.createElement(Person, {props:  this.props.actor}) ) );          }
        } else {
      ...
      if( this.props.transcript ){
        if( this.props.transcript instanceof Array ){
          transcript = [(React.createElement("p", null, "transcript:") )];
          for( i in this.props.transcript ){
            transcript.push( ( React.createElement("div", {class: "transcript"}) ) );
          }
        } else {
          transcript = ( React.createElement("div", {class: "transcript"}, this.props.transcript) );
        }
      }
      var contentLocation;
