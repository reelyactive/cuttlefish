    ...
    render: function(){
      ...
      if( this.props.priceValidUntil ){
        if( this.props.priceValidUntil instanceof Array ){
          priceValidUntil = [(React.createElement("p", null, "priceValidUntil:") )];
          for( i in this.props.priceValidUntil ){
            priceValidUntil.push( ( React.createElement("div", {class: "priceValidUntil"}) ) );
          }
        } else {
          priceValidUntil = ( React.createElement("div", {class: "priceValidUntil"}, this.props.priceValidUntil) );
        }
      }
      var sameAs;
      ...
      if( this.props.addOn ){
        if( this.props.addOn instanceof Array ){
          addOn = [(React.createElement("p", null, "addOn:") )];
