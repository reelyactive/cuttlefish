    ...
    render: function(){
      ...
      if( this.props.longitude ){
        if( this.props.longitude instanceof Array ){
          longitude = [(React.createElement("p", null, "longitude:") )];
          for( i in this.props.longitude ){
            longitude.push( ( React.createElement("div", {class: "longitude"}) ) );
          }
        } else {
          longitude = ( React.createElement("div", {class: "longitude"}, this.props.longitude) );
        }
      }
      ...
      if( this.props.latitude ){
        if( this.props.latitude instanceof Array ){
          latitude = [(React.createElement("p", null, "latitude:") )];
          for( i in this.props.latitude ){
            latitude.push( ( React.createElement("div", {class: "latitude"}) ) );
          }
        } else {
          latitude = ( React.createElement("div", {class: "latitude"}, this.props.latitude) );
        }
      }
      var additionalType;
