      ...
      if( props.recordLabel ){
        if( props.recordLabel instanceof Array ){
          ...
          for( i in props.recordLabel ){
            recordLabel.push( ( React.createElement(Organization, React.__spread({},  props.recordLabel )) ) );          }
        } else {
      ...
      if( props.releaseOf ){
        if( props.releaseOf instanceof Array ){
          ...
          for( i in props.releaseOf ){
            releaseOf.push( ( React.createElement(MusicAlbum, React.__spread({},  props.releaseOf )) ) );          }
        } else {
      ...
      if( props.musicReleaseFormat ){
        if( props.musicReleaseFormat instanceof Array ){
          ...
          for( i in props.musicReleaseFormat ){
            musicReleaseFormat.push( ( React.createElement(MusicReleaseFormatType, React.__spread({},  props.musicReleaseFormat )) ) );          }
        } else {
      ...
      if( props.numTracks ){
        if( props.numTracks instanceof Array ){
          ...
          for( i in props.numTracks ){
            numTracks.push( ( React.createElement(Integer, React.__spread({},  props.numTracks )) ) );          }
        } else {
