    ...
    render: function(){
      ...
      if( this.props.recordLabel ){
        if( this.props.recordLabel instanceof Array ){
          recordLabel = [(React.createElement("p", null, "recordLabel:") )];
          for( i in this.props.recordLabel ){
            recordLabel.push( ( React.createElement(Organization, {props:  this.props.recordLabel}) ) );          }
        } else {
      ...
      if( this.props.catalogNumber ){
        if( this.props.catalogNumber instanceof Array ){
          catalogNumber = [(React.createElement("p", null, "catalogNumber:") )];
          for( i in this.props.catalogNumber ){
            catalogNumber.push( ( React.createElement("div", {class: "catalogNumber"}) ) );
          }
        } else {
          catalogNumber = ( React.createElement("div", {class: "catalogNumber"}, this.props.catalogNumber) );
        }
      }
      var isPartOf;
      ...
      if( this.props.releaseOf ){
        if( this.props.releaseOf instanceof Array ){
          releaseOf = [(React.createElement("p", null, "releaseOf:") )];
          for( i in this.props.releaseOf ){
            releaseOf.push( ( React.createElement(MusicAlbum, {props:  this.props.releaseOf}) ) );          }
        } else {
      ...
      if( this.props.creditedTo ){
        if( this.props.creditedTo instanceof Array ){
          creditedTo = [(React.createElement("p", null, "creditedTo:") )];
          for( i in this.props.creditedTo ){
            creditedTo.push( ( React.createElement("div", {class: "creditedTo"}) ) );
          }
        } else {
          creditedTo = ( React.createElement("div", {class: "creditedTo"}, this.props.creditedTo) );
        }
      }
      var award;
      if( this.props.award ){
      ...
      if( this.props.musicReleaseFormat ){
        if( this.props.musicReleaseFormat instanceof Array ){
          musicReleaseFormat = [(React.createElement("p", null, "musicReleaseFormat:") )];
          for( i in this.props.musicReleaseFormat ){
            musicReleaseFormat.push( ( React.createElement(MusicReleaseFormatType, {props:  this.props.musicReleaseFormat}) ) );          }
        } else {
      ...
      if( this.props.numTracks ){
        if( this.props.numTracks instanceof Array ){
          numTracks = [(React.createElement("p", null, "numTracks:") )];
