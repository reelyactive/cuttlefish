      ...
      if( props.inPlaylist ){
        if( props.inPlaylist instanceof Array ){
          ...
          for( i in props.inPlaylist ){
            inPlaylist.push( ( React.createElement(MusicPlaylist, React.__spread({},  props.inPlaylist )) ) );          }
        } else {
      ...
      if( props.byArtist ){
        if( props.byArtist instanceof Array ){
          ...
          for( i in props.byArtist ){
            byArtist.push( ( React.createElement(MusicGroup, React.__spread({},  props.byArtist )) ) );          }
        } else {
      ...
      if( props.recordingOf ){
        if( props.recordingOf instanceof Array ){
          ...
          for( i in props.recordingOf ){
            recordingOf.push( ( React.createElement(MusicComposition, React.__spread({},  props.recordingOf )) ) );          }
        } else {
      ...
      if( props.inAlbum ){
        if( props.inAlbum instanceof Array ){
          ...
          for( i in props.inAlbum ){
            inAlbum.push( ( React.createElement(MusicAlbum, React.__spread({},  props.inAlbum )) ) );          }
        } else {
