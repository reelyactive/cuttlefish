    ...
    render: function(){
      ...
      if( this.props.inPlaylist ){
        if( this.props.inPlaylist instanceof Array ){
          inPlaylist = [(React.createElement("p", null, "inPlaylist:") )];
      ...
      if( this.props.byArtist ){
        if( this.props.byArtist instanceof Array ){
          byArtist = [(React.createElement("p", null, "byArtist:") )];
      ...
      if( this.props.recordingOf ){
        if( this.props.recordingOf instanceof Array ){
          recordingOf = [(React.createElement("p", null, "recordingOf:") )];
      ...
      if( this.props.inAlbum ){
        if( this.props.inAlbum instanceof Array ){
          inAlbum = [(React.createElement("p", null, "inAlbum:") )];
      ...
      if( this.props.isrcCode ){
        if( this.props.isrcCode instanceof Array ){
          isrcCode = [(React.createElement("p", null, "isrcCode:") )];
          for( i in this.props.isrcCode ){
            isrcCode.push( ( React.createElement("div", {class: "isrcCode"}) ) );
          }
        } else {
          isrcCode = ( React.createElement("div", {class: "isrcCode"}, this.props.isrcCode) );
        }
      }
      var educationalUse;
