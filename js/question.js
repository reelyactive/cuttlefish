...
"Organization."}) );
      ...
      if( this.props.answerCount ){
        if( this.props.answerCount instanceof Array ){
          answerCount = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.answerCount ){
            answerCount.push( ( React.createElement(Integer, React.__spread({},  this.props.answerCount )) ) );          }
        } else {
          answerCount = ( React.createElement(Integer, {props:  this.props.answerCount}) );        }
      }
      var hasPart;
      ...
      if( this.props.acceptedAnswer ){
        if( this.props.acceptedAnswer instanceof Array ){
          acceptedAnswer = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.acceptedAnswer ){
            acceptedAnswer.push( ( React.createElement(Answer, React.__spread({},  this.props.acceptedAnswer )) ) );          }
        } else {
          acceptedAnswer = ( React.createElement(Answer, {props:  this.props.acceptedAnswer}) );        }
      }
      var downvoteCount;
      if( this.props.downvoteCount ){
        if( this.props.downvoteCount instanceof Array ){
          downvoteCount = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.downvoteCount ){
            downvoteCount.push( ( React.createElement(Integer, React.__spread({},  this.props.downvoteCount )) ) );          }
        } else {
          downvoteCount = ( React.createElement(Integer, {props:  this.props.downvoteCount}) );        }
      }
      var recordedAt;
...
"Text."}) );
      ...
      if( this.props.suggestedAnswer ){
        if( this.props.suggestedAnswer instanceof Array ){
          suggestedAnswer = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.suggestedAnswer ){
            suggestedAnswer.push( ( React.createElement(Answer, React.__spread({},  this.props.suggestedAnswer )) ) );          }
        } else {
          suggestedAnswer = ( React.createElement(Answer, {props:  this.props.suggestedAnswer}) );        }
      }
      ...
      if( this.props.upvoteCount ){
        if( this.props.upvoteCount instanceof Array ){
          upvoteCount = [( React.createElement("div", {"data-advice": "HTML for the *head* of the section"}) )];
          for( i in this.props.upvoteCount ){
            upvoteCount.push( ( React.createElement(Integer, React.__spread({},  this.props.upvoteCount )) ) );          }
        } else {
          upvoteCount = ( React.createElement(Integer, {props:  this.props.upvoteCount}) );        }
      }
