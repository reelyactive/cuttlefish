...
"Organization."}) );
      ...
      if( props.answerCount ){
        if( props.answerCount instanceof Array ){
          ...
          for( i in props.answerCount ){
            answerCount.push( ( React.createElement(Integer, React.__spread({},  props.answerCount )) ) );          }
        } else {
      ...
      if( props.acceptedAnswer ){
        if( props.acceptedAnswer instanceof Array ){
          ...
          for( i in props.acceptedAnswer ){
            acceptedAnswer.push( ( React.createElement(Answer, React.__spread({},  props.acceptedAnswer )) ) );          }
        } else {
      ...
      if( props.downvoteCount ){
        if( props.downvoteCount instanceof Array ){
          ...
          for( i in props.downvoteCount ){
            downvoteCount.push( ( React.createElement(Integer, React.__spread({},  props.downvoteCount )) ) );          }
        } else {
...
"Text."}) );
      ...
      if( props.suggestedAnswer ){
        if( props.suggestedAnswer instanceof Array ){
          ...
          for( i in props.suggestedAnswer ){
            suggestedAnswer.push( ( React.createElement(Answer, React.__spread({},  props.suggestedAnswer )) ) );          }
        } else {
      ...
      if( props.upvoteCount ){
        if( props.upvoteCount instanceof Array ){
          ...
          for( i in props.upvoteCount ){
            upvoteCount.push( ( React.createElement(Integer, React.__spread({},  props.upvoteCount )) ) );          }
        } else {
